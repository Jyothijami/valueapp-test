<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WalkInNew.aspx.cs" Inherits="Telerik_Pages_WalkInNew" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row">
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteColumn="True" AutoGenerateEditColumn="True"   DataSourceID="SqlDataSource1" ShowGroupPanel="True" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" PageSize="20" CellSpacing="-1" GridLines="Both" Skin="Default">
                ...
                <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="ID" CommandItemDisplay="Top" Font-Size="Larger" BorderColor="Red">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Source" ItemStyle-Width="240px">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Automation Explained" ItemStyle-Width="240px">
                            <ItemTemplate>
