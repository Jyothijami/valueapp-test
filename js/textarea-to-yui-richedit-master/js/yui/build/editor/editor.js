...
var Dom = YAHOO.util.Dom,
    ...
    */
    ...
    YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
        ...
        * @type String
        */
        _defaultCSS: 'html { height: 95%; } body { padding: 7px; background-color: #fff; font: 13px/1.22 'segoe UI' , Tahoma, Geneva, 'segoe UI' , Tahoma, Geneva, Verdana, sans-serif, sans-serif,helvetica,clean,sans-serif;*font-size:small;*font:x-small; } a, a:visited, a:hover { color: blue !important; text-decoration: underline !important; cursor: text !important; } .warning-localfile { border-bottom: 1px dashed red !important; } .yui-busy { cursor: wait !important; } img.selected { border: 2px dotted #808080; } img { cursor: pointer !important; border: none; } body.ptags.webkit div.yui-wk-p { margin: 11px 0; } body.ptags.webkit div.yui-wk-div { margin: 0; }',
        /**
                ...
                this._defaultToolbar = {
                    ...
                    buttons: [
                        { group: 'fontstyle', label: 'Font Name and Size',
                            buttons: [
                                { type: 'select', label: ''segoe UI' , Tahoma, Geneva, 'segoe UI' , Tahoma, Geneva, Verdana, sans-serif, sans-serif', value: 'fontname', disabled: true,
                                    menu: [
                                        { text: ''segoe UI' , Tahoma, Geneva, 'segoe UI' , Tahoma, Geneva, Verdana, sans-serif, sans-serif', checked: true },
                                        { text: ''segoe UI' , Tahoma, Geneva, 'segoe UI' , Tahoma, Geneva, Verdana, sans-serif, sans-serif Black' },
                                        { text: 'Comic Sans MS' },
                                        { text: 'Courier New' },
                                        { text: 'Lucida Console' },
                                        { text: 'Tahoma' },
        ...
        */
        initAttributes: function(attr) {
            ...
            * @default <code><pre>html {
            ...
            body {
                height: 100%;
                padding: 7px; background-color: #fff; font:13px/1.22 'segoe UI' , Tahoma, Geneva, 'segoe UI' , Tahoma, Geneva, Verdana, sans-serif, sans-serif,helvetica,clean,sans-serif;*font-size:small;*font:x-small;
            }
            a {
                color: blue;
        ...
        * @param {String} value (optional) The value for a given action such as action: fontname value: ''segoe UI' , Tahoma, Geneva, Verdana, sans-serif'
