<%@ Page Title="" Language="C#" MasterPageFile="~/tsmast.master" AutoEventWireup="true" CodeFile="TEST9.aspx.cs" Inherits="TEST9" %>
    ...
    <script type="text/javascript">
       ...
       <script type="text/javascript">
           $(document).ready(function () {
               $("#Books").select2({ placeholder: 'Find and Select emp' });
           });
       </script>
...
<asp:Label ID="lblItem" runat ="server" Visible ="false" ></asp:Label>
                        ...
                        <div>
                            <asp:GridView ID="gvList" Width="100%" runat="server" SelectedRowStyle-BackColor="#c0c0c0" EmptyDataText="No Records To Display" AllowPaging="True" OnPageIndexChanging="gvList_PageIndexChanging" PageSize="8" AutoGenerateColumns="False" >
                    <Columns>
