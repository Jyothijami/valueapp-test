<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/HRMP1.master" AutoEventWireup="true" CodeFile="NewEmpRating.aspx.cs" Inherits="Survey_NewEmpRating" %>
    ...
    <asp:GridView ID="gvEmployeeMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="true" 
                ...
                <ItemTemplate>
                    <div class="row">
                        ...
                        <a runat="server" class="btn btn-icon btn-primary " href='<%# "~/Survey/EmpRating.aspx?Cid=" + Eval("EMP_ID") %>' onclick="OpenPopupCenter(this.href, 'newwindow', 500, 500);return false; ">
