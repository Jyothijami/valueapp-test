...
(function($) {
    ...
    function _902(_903, _904) {
        ...
        for (var i = 0; i < _904.length; i++) {
            var _908 = $("<input id=\"cbtextvalue\" type=\"hidden\" class=\"textbox-value\">").appendTo(_906);
            _908.attr("name", name);
            if (opts.disabled) {
...
(function($) {
    function _96a(_96b) {
        var _96c = $.data(_96b, "combotree"); //alert($(_96b).attr("id"));
        ...
        tree.tree($.extend({}, opts, {
            ...
            onClick: function(node) {
                ...
                //alert($(_96b).attr("id"));
                $("#" + $(_96b).attr("id") + "_value").val(node.id);
                $("#" + $(_96b).attr("id") + "_text").val(node.text);
