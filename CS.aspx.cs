...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        string query = "select YANTRA_EMPLOYEE_MAST .EMP_ID as EmployeeId,EMP_FIRST_NAME +' '+EMP_LAST_NAME as EmployeeName,DESG_NAME,dept_name,EMP_PHOTO,YANTRA_DEPT_MAST.dept_head, Reporting_ID";
        ...
        using (SqlConnection con = new SqlConnection(constr))
        {
            using (SqlCommand cmd = new SqlCommand(query))
            {
                ...
                {
                    sdr["EmployeeId"], sdr["EmployeeName"], sdr["DESG_NAME"] , sdr["dept_name"],sdr["EMP_PHOTO"],sdr["Reporting_ID"]
                });
                    }
                }
                con.Close();
