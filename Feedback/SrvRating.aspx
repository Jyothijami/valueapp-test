<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SrvRating.aspx.cs" Inherits="Feedback_SrvRating" %>
    ...
    <span class='arrow entypo-resize-full'></span>
        ...
        <div id='content'>
            <div id='right'>
                ...
                <p style ="font-weight :bold; color :#ffdd33 ">1. <asp:Label ID="Label4" runat="server" Text="How satisfied are you with our service?"></asp:Label></p>
      ...
      <div class="radio radiobuttonlist col-sm-9"><p>
        <asp:RadioButtonList ID="rdbRating" CssClass="container" runat ="server" AutoPostBack ="true"  RepeatLayout="Flow" OnSelectedIndexChanged="rdbRating_SelectedIndexChanged" >
            <asp:ListItem >Very Satisfied</asp:ListItem>
            <asp:ListItem >Satisfied</asp:ListItem>
            <asp:ListItem >Neither Satisified nor Dissatisfied</asp:ListItem>
            <asp:ListItem >Dissatisfied</asp:ListItem>
            <asp:ListItem >Very Dissatisfied</asp:ListItem>
        </asp:RadioButtonList></p>
      </div>
                <p>
       <asp:Label CssClass="container" ID="lbl1" Visible ="false" ForeColor ="#ff3434" Font-Bold ="true"    runat ="server" Text="Please let us know what went wrong"></asp:Label></p>
                                            
       <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txt1" CssClass="container" TextMode ="MultiLine" Visible ="false"   runat ="server"></asp:TextBox>
                </p> 
                <br />
                   
                 <p style ="font-weight :bold; color :#ffdd33 ">2. <asp:Label ID="Label1" runat="server" Text="Please rate our Technician on the following "></asp:Label></p>
                 <p style="font:bolder;color:yellow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="Behaviour "></asp:Label></p>
                <div class="radio radiobuttonlist col-sm-9"><p>
                    <asp:RadioButtonList ID="rdbbehaviour" AutoPostBack ="true" RepeatDirection="Horizontal"  RepeatLayout="Flow" runat ="server" OnSelectedIndexChanged="rdbbehaviour_SelectedIndexChanged" EnableTheming="False" >
                ...
                <%--<div class="wrap">--%>
                   <%-- <form action="">--%>
                    <p style="font:bolder;color:yellow">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label5" runat="server" Text="Knowledge "></asp:Label></p>
                        ...
                        <%--</form>--%> 
                <%--</div>--%>
                <div class="radio radiobuttonlist col-sm-9"><p> <asp:RadioButtonList ID="rdbknwldg" CssClass="container" RepeatLayout="Flow" RepeatDirection="Horizontal" runat ="server" >
                    <asp:ListItem Value ="1"  >Good</asp:ListItem>
                ...
                <%--<p>3. <asp:Label ID="Label3" runat="server" Text="Is any spare part suggested by our techncian?"></asp:Label></p>
                <div class="radio radiobuttonlist col-sm-9"><p> <asp:RadioButtonList ID="rdbsp" AutoPostBack ="true" RepeatLayout="Flow" RepeatDirection="Horizontal"  CssClass="container"  runat ="server" OnSelectedIndexChanged="rdbsp_SelectedIndexChanged" >
                ...
                <p><asp:TextBox ID="TextBox1" Visible ="false"  TextMode ="MultiLine"   runat ="server"></asp:TextBox></p>--%>
                 <p style ="font-weight :bold; color :#ffdd33 ">3. <asp:Label ID="Label6" runat="server" Text="Would you recommend us to a friend?"></asp:Label></p>
                 <div class="radio radiobuttonlist col-sm-9"> <p> <asp:RadioButtonList ID="rdbrecommend" CssClass="container" RepeatLayout="Flow" RepeatDirection="Horizontal" runat ="server" >
                    <asp:ListItem Value ="1"  >Yes</asp:ListItem>
                    <%--<asp:ListItem Value ="2"  >Bad</asp:ListItem>--%>
                ...
                <p style ="font-weight :bold; color :#ffdd33 ">4. <asp:Label ID="Label7" runat="server" Text="If you have any other comments please mention below"></asp:Label></p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox  ID="TextBox2" CssClass="container" TextMode ="MultiLine"   runat ="server"></asp:TextBox></p>
        ...
        <div id="buttons">
            <asp:Button  ID="btnCancel" runat="server" CssClass ="clear " Text="Clear" BackColor="#e9e9e9" OnClick="btnCancel_Click" Width="100px"  />   
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:Button ID="btnSubmit" runat="server" CssClass ="submit " Text="Submit" BackColor="#66FF66" OnClick="btnSubmit_Click" Width="100px"  />  
