<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRLA.aspx.cs" Inherits="LeaveApprove" %>
...
<body>
    ...
    <span class='arrow entypo-resize-full'></span>
        ...
        <p style="text-align:left; font:bolder; ">Type of Applied Leave : <asp:Label ID="lblLeaveType" runat="server" Text="Label"></asp:Label></p>
