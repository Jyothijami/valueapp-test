...
using vllib;
public partial class Modules_CRM_Invoice : basePage
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        {
            if (!string.IsNullOrEmpty(gvSalesInvoiceDetails.SelectedRow.Cells[12].Text) && gvSalesInvoiceDetails.SelectedRow.Cells[12].Text != "&nbsp;")
            {
    ...
    protected void lbtnSalesInvoiceNo_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("InvoiceDetails.aspx?SI_ID=" + gvSalesInvoiceDetails.SelectedRow.Cells[0].Text
        + "&AppBy=" + gvSalesInvoiceDetails.SelectedRow.Cells[12].Text
        + "&DcFor=" + gvSalesInvoiceDetails.SelectedRow.Cells[5].Text);
        ...
        try
        {
            ...
            if (objInventory.SalesInvoice_Select(gvSalesInvoiceDetails.SelectedRow.Cells[0].Text) > 0)
            {
                ...
                if (objInventory.SIVAT == "0" && objInventory.SICSTax == "0")
                {
                    rbCST.Checked = false;
                    rbVAT.Checked = false;
                }
