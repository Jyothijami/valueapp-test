<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/FinanceMP1.master" AutoEventWireup="true" CodeFile="InvoiceDetails.aspx.cs" Inherits="Modules_Inventory_InvoiceDetails" %>
    ...
    splamt = document.getElementById('<%=txtSpPrice.ClientID %>').value;
       ...
       function amtcalcDisc1() {
        ...
        function GST_amtcalc() {
            ...
            gst_Tax = document.getElementById('<%=txtItemGST_Perc.ClientID %>').value;
    spprice = document.getElementById('<%=txtSpPrice.ClientID %>').value;

            if (gst_Tax == "" || gst_Tax == "0") {
                document.getElementById('<%=txtItemGST_Amt.ClientID %>').value = "0";
            }
            else if (spprice == "" || spprice == "0") {
                document.getElementById('<%=txtItemGST_Amt.ClientID %>').value = "0";
    }
    else if (spprice > 0 && gst_Tax > 0) {
        document.getElementById('<%=txtItemGST_Amt.ClientID %>').value = parseFloat((spprice * gst_Tax) / 100).toFixed(2);
    }
        }
        ...
        function Gst_Disc_calc() {
            ...
            gst_Amt = document.getElementById('<%=txtItemGST_Amt.ClientID %>').value;
    spprice = document.getElementById('<%=txtSpPrice.ClientID %>').value;

            if (gst_Amt == "" || gst_Amt == "0") {
                document.getElementById('<%=txtItemGST_Perc.ClientID %>').value = "0";
    }
    else if (spprice == "" || spprice == "0") {
        document.getElementById('<%=txtItemGST_Perc.ClientID %>').value = "0";
    }
        ...
        document.getElementById('<%=txtItemGST_Perc.ClientID %>').value = parseFloat((gst_Amt * 100) / spprice).toFixed(2);
    }
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" id="tblSIDetails" runat="server"
                            ...
                            <tr>
                                <td style="height: 22px; text-align: right">
                                    <asp:Label ID="Label35" runat="server" Text="Select Nick Name"></asp:Label></td>
                                <td style="height: 22px; text-align: left">
                                    <asp:DropDownList ID="ddlNickName" runat="server" AutoPostBack="True" EnableTheming="False" OnSelectedIndexChanged ="ddlNickName_SelectedIndexChanged" Width="200px">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="ddlunitname" Enabled ="false"  runat="server" OnSelectedIndexChanged="ddlunitname_SelectedIndexChanged" AutoPostBack="True">
                                    </asp:DropDownList></td>
                                <td style="height: 22px; text-align: right">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 439px;">
                                    <asp:TextBox ID="txtChallanDate" runat="server" ReadOnly="True" type="datepic">
                                ...
                                <td colspan="4" align="center">
                                    <asp:GridView ID="gvInvoicedItems" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvItmDetails_RowDeleting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Vat" HeaderText="GST(%)">
                                                <HeaderStyle HorizontalAlign="Center" />
                                            ...
                                            <%--<asp:BoundField HeaderText="GST (%)" DataField ="DetGST">
                                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <tr>
                               <td style="text-align: right" class="auto-style1">
                                    <asp:Label ID="Label33" runat="server" Text="Tally InvoiceNo" Width="101px" ></asp:Label></td>
                                <td style="text-align: left" class="auto-style1">
                                    <asp:TextBox ID="txtInno" runat="server" CausesValidation="True" ></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtDeliveryDate" runat="server" type="datepic"></asp:TextBox></td>
                                <td style="text-align: right">
                            ...
                            <tr>
                                <td style="text-align:right"><asp:Label runat="server" Text="GST(%)"></asp:Label></td>
                                <td style="text-align:left"><asp:TextBox ID="txtItemGST_Perc" runat="server"></asp:TextBox></td>
                                <td style="text-align:right"><asp:Label ID="lblgstAmt" runat="server" Text="GST Amount"></asp:Label></td>
                                <td style="text-align :left"><asp:TextBox ID="txtItemGST_Amt" runat="server" ></asp:TextBox></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;"></td>
                                <td style="text-align: left; width: 439px;">
                                    <asp:RadioButton ID="rbVAT" runat="server" Checked="True" OnCheckedChanged="rbVAT_CheckedChanged" GroupName="vatcst" Text="CGST/SGST" /><asp:RadioButton
                                        ID="rbCST" runat="server" OnCheckedChanged="rbCST_CheckedChanged" GroupName="vatcst" Text="IGST" />
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    ...
                                    <asp:TextBox ID="txtTax_Old" runat ="server" ReadOnly ="true" ></asp:TextBox>
                                    <asp:Label ID="lblper" runat ="server" Text="%"></asp:Label>
                                    <asp:Label ID="lbltax" runat ="server" Text="(Old VAT/CS Tax Details if any)" ForeColor="#CC3300"></asp:Label><cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtMiscelleneous"
