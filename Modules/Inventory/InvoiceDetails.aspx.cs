...
public partial class Modules_Inventory_InvoiceDetails : basePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (txtTax_Old.Text == "") { txtTax_Old.Text = "0"; }
        txtGrossAmount.Text = Convert.ToString(Convert.ToDecimal(txtGrossTotalAmtHidden.Value) + Convert.ToDecimal(txtMiscelleneous.Text) + Convert.ToDecimal(txtVAT.Text) + Convert.ToDecimal(txtCST.Text) + Convert.ToDecimal(txtBranchTransfer.Text) + ((Convert.ToDecimal(txtTax_Old.Text) * (Convert.ToDecimal(txtGrossTotalAmtHidden.Value))) / 100) - ((Convert.ToDecimal(txtDiscount.Text) * (Convert.ToDecimal(txtGrossTotalAmtHidden.Value))) / 100));
        ...
        if (!IsPostBack)
        {
            ...
            txtItemGST_Perc.Attributes.Add("onkeyup", "javascript:GST_amtcalc();");
            txtItemGST_Amt.Attributes.Add("onkeyup", "javascript:Gst_Disc_calc();");
            ...
            txtTax_Old.Attributes.Add("onKeyup", "javascript:grosscalc();");
            ...
            if (Request.QueryString["SI_ID"] != null)
            {
                ...
                try
                {
                    ...
                    if (objInventory.SalesInvoice_Select(Request.QueryString["SI_ID"].ToString()) > 0)
                    {
                        ...
                        if (objInventory.SIVAT == "14.5")
                        {
                            txtTax_Old.Text = objInventory.SIVAT;
                        }
                        else if (objInventory.SICSTax == "2")
                        {
                            txtTax_Old.Text = objInventory.SICSTax;
                        }
                        else if (objInventory.SICSTax == "14.5")
                        {
                            txtTax_Old.Text = objInventory.SICSTax;
                        }
                        else { txtTax_Old.Text = "0"; }
                        ...
                        if(gvItmDetails.Rows.Count==0)
                        {
                            ...
                            if (objInventory.SIVAT == "0" && objInventory.SIBranchTransfer == "0")
                            {
                                txtCST.Text = lblTtlGSTAmt.Text;
                            }
                            else if (objInventory.SICSTax == "0" && objInventory.SIBranchTransfer == "0")
                            {
                                txtVAT.Text = lblTtlGSTAmt.Text;
                            }
                            else if (objInventory.SICSTax == "0" && objInventory.SIVAT == "0")
                            {
                                txtBranchTransfer.Text = lblTtlGSTAmt.Text;
                            }
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        else if (rbCST.Checked == true)
        {
            ...
            txtCST.Text = (Convert.ToDecimal(txtVAT.Text) + Convert.ToDecimal(lblTtlGSTAmt.Text)).ToString();
        }
        else if (rbCST.Checked == true)
        {
            txtVAT.Style.Add("display", "none");
            ...
            txtBranchTransfer.Text = (Convert.ToDecimal(txtVAT.Text) + Convert.ToDecimal(lblTtlGSTAmt.Text)).ToString();
        }
        #endregion
    ...
    private void EmployeeMaster_Fill()
    {
        try
        {
            ...
            HR.EmployeeMaster.EmployeeMaster_SelectAllSales12(ddlApprovedBy);
            ...
            try
            {
                ...
                if (objInventory.SalesInvoice_Save() == "Data Saved Successfully")
                {
                    ...
                    foreach (GridViewRow gvrow in gvItmDetails.Rows)
                    {
                        ...
                        objInventory.sicoLORID = gvrow.Cells[16].Text;
                        objInventory.Remarks = gvrow.Cells[17].Text;
                     ...
                     foreach (GridViewRow gvrow in gvItmDetails.Rows)
                    {
                        ...
                        objInventory.DCInvoiceDtls_Update(gvrow.Cells[18].Text);
                    }
        ...
        if (lblSalesOrderNo.Text == "Sales Order No.")
        {
            try
            {
                ...
                if (objSM.SalesOrder_Select(ddlSalesOrderNo.SelectedItem.Value) > 0)
                {
                    ...
                    ddlApprovedBy.SelectedValue = objSM.SORespId;
    ...
    protected void gvItemDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            e.Row.Cells[6].Text = (Convert.ToDecimal(e.Row.Cells[7].Text) / Convert.ToDecimal(e.Row.Cells[4].Text)).ToString("F");
            e.Row.Cells[9].Text = (Convert.ToDecimal(e.Row.Cells[7].Text) * (Convert.ToDecimal(e.Row.Cells[8].Text)) / 100).ToString("F");
        }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
            ...
            foreach (GridViewRow gvrow in gvItmDetails.Rows)
            {
                if (gvItmDetails.SelectedIndex > -1)
                {
                    if (gvrow.RowIndex == gvItmDetails.SelectedRow.RowIndex)
                    {
                        ...
                        dr["DetId"] = "-";
                        //dr["GST_TAX"] = txtItemGST_Perc.Text;
        ...
        if (gvItmDetails.SelectedIndex == -1)
        {
            ...
            drnew["VAT"] = txtItemGST_Perc.Text;
            drnew["Cst"] = "0";
            drnew["Excise"] = "0";
            ...
            drnew["DetId"] = "-";
            //drnew["GST_TAX"] = txtItemGST_Perc.Text;
    ...
    protected void btnItemRefresh_Click(object sender, EventArgs e)
    {
        ...
        txtItemGST_Perc.Text = string.Empty;
        txtItemGST_Amt.Text = string.Empty;
        txtDiscount1.Text = "";
        txtSpPrice.Text = "";
        txtUnitprice.Text = "";
        gvItmDetails.SelectedIndex = -1;
    ...
    protected void gvItmDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            if (e.Row.Cells[11].Text == "" || e.Row.Cells[11].Text == null) { e.Row.Cells[11].Text = "0"; }
            ...
            e.Row.Cells[13].Text = (Convert.ToDecimal(e.Row.Cells[11].Text) * Convert.ToDecimal(e.Row.Cells[8].Text) / 100).ToString();
            //(Convert.ToDecimal(e.Row.Cells[11].Text) * Convert.ToDecimal(e.Row.Cells[22].Text) / 100).ToString();
        }
    ...
    protected void ddlModelNo_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (objMaster.ItemMaster_Select(ddlModelNo.SelectedItem.Value) > 0)
            {
                ...
                txtItemGST_Perc.Text = objMaster.GST_Tax;
                if (txtItemGST_Perc.Text == "" || txtItemGST_Perc.Text == null)
                {
                    txtItemGST_Perc.Text = "0";
                }
                    ...
                    foreach (GridViewRow gvrow1 in gvItmDetails.Rows)
                    {
                        if (gvItmDetails.SelectedIndex > -1)
                        {
                            ...
                            else
                            {
                                ...
                                dr["Remarks"] = gvrow1.Cells[17].Text;
                        ...
                        else
                        {
                            ...
                            dr["Excise"] = "0";
                            //dr["Priority"] = gvrow1.Cells[11].Text;
                            dr["DeliveryDate"] = gvrow1.Cells[14].Text;
                            //dr["Room"] = gvrow1.Cells[13].Text;
                            dr["SPPrice"] = gvrow1.Cells[12].Text;
                            dr["DCId"] = gvrow1.Cells[15].Text;
                            dr["ColorId"] = gvrow1.Cells[16].Text;
                        ...
                        if (gvItmDetails.SelectedIndex == -1)
                        {
                            if (gvrow.Cells[2].Text == gvrow1.Cells[3].Text && gvrow.Cells[9].Text == gvrow1.Cells[14].Text)
                            {
    ...
    protected void gvDeliveryChallanItems_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[7].Text = (Convert.ToDecimal(e.Row.Cells[11].Text) / Convert.ToDecimal(e.Row.Cells[12].Text)).ToString("F");
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[8].Text = (Convert.ToDecimal(e.Row.Cells[7].Text) * Convert.ToDecimal(e.Row.Cells[5].Text)).ToString("F");
        }
    ...
    protected void gvInvoicedItems_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            e.Row.Cells[17].Attributes.Add("onclick", "return confirm('Are you sure you want to remove this Item from Products list?');");
            e.Row.Cells[1].Attributes.Add("onclick", "return confirm('Are you sure you want to remove this Item from Interested Products list?');");
    ...
    protected void lbtnDelete_Click(object sender, EventArgs e)
    {
        ...
        Inventory.SalesInvoice objInventory = new Inventory.SalesInvoice();
        objInventory.SalesInvoiceItems_Delete(gvInvoicedItems.SelectedRow.Cells[16].Text);
