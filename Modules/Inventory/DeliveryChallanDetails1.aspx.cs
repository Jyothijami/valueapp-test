...
public partial class Modules_Inventory_DeliveryChallanDetails : basePage
{
                                ...
                                if (ViewState["ProductsSold"] != null)
                                {
                                    ...
                                    if (dtCurrentTable.Rows.Count > 0)
                                    {
                                        ...
                                        for (int j = 1; j <= dtCurrentTable.Rows.Count; j++)
                                        {
                                            ...
                                            drCurrentRow["Item_ID"] = dt.Rows[i][0].ToString();
                                            drCurrentRow["Barcode"] = dt.Rows[i][0].ToString();
                                            drCurrentRow["ITEM_CODE"] = gvrow.Cells[2].Text;
                                            drCurrentRow["Cp_Id"] = dt.Rows[i][3].ToString();
                                            drCurrentRow["whLocId"] = dt.Rows[i][1].ToString();
                                            drCurrentRow["dt_added"] = DateTime.Now.ToString();
                                            drCurrentRow["COLOUR_ID"] = dt.Rows[i][2].ToString();
                                            drCurrentRow["PO_NO"] = ddlSalesOrderNo.SelectedItem.Value;
                                            drCurrentRow["CUSTOMERID"] = lblCustId.Text;
    ...
    private void Outward_Delete()
    {
        ...
        //{
        int i = Convert.ToInt32(lblQty.Text);
