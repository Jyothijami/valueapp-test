<%@ Page Language="C#" MasterPageFile="~/MPs/InventoryMP1.master" AutoEventWireup="true" CodeFile="SampleDc2.aspx.cs" Async="true"
                ...
                <tr>
                    <td colspan="4">
                        <asp:GridView ID="gvDeliveryChallanDetails" SelectedRowStyle-BackColor="#c0c0c0" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            Width="100%" AllowSorting="True" OnPageIndexChanging="gvDeliveryChallanDetails_PageIndexChanging">
                            <Columns>
                        ...
                        <a runat="server" class="btn btn-icon btn-primary" href='<%# "~/Modules/Inventory/DCDoc1.aspx?Cid=" + Eval("DC_ID") %>' onclick="OpenPopupCenter(this.href, 'newwindow', 800, 500);return false; ">
                            <span style="color:white"><strong> Docs</strong> </span>
                                <asp:Label ID="Label2"  class="label label-danger"  runat="server" Text='<%#Eval("DocCou") %>'></asp:Label>
                        </a>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
                            ...
                            <SelectParameters>
                                ...
                                <asp:ControlParameter Name="EMPID" ControlID="lblEmpId" PropertyName="Text" Type="Int64" DefaultValue="0"></asp:ControlParameter>
                                <asp:ControlParameter Name="UserType" ControlID="lblTypeUser" PropertyName="Text" Type="Int64" DefaultValue="0"></asp:ControlParameter>

                            </SelectParameters>
                        </asp:SqlDataSource>
                        &nbsp;
                        
                                        <asp:Label ID="lblTypeUser" runat="server" Visible="False"></asp:Label>
                    ...
                    <td>
                        <table id="tblAssignTasks" runat="server" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 388px;">
                                    <asp:TextBox ID="txtAssignDate" runat="server" CssClass="datetext" type="datepic" EnableTheming="False"
                                        Width="130px">
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtDueDate" runat="server" CssClass="datetext" type="datepic" EnableTheming="False"
                                        Width="130px">
                    ...
                    <td colspan="4">
                        <table border="0" cellpadding="0" cellspacing="0" id="tblDCDetails" runat="server"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtCustOrderDate" runat="server" type="datepic" CssClass="datetext"
                            ...
                            <tr>
                                <td style="height: 22px; text-align: right">
                                    <asp:Label ID="Label52" runat="server" Text="Select Nick Name"></asp:Label></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:DropDownList ID="ddlDCType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDCType_SelectedIndexChanged">
                                        <asp:ListItem Value="0">--</asp:ListItem>
                                        <asp:ListItem>Returnable/Sample Purpose</asp:ListItem>
                                        <asp:ListItem>Non Returnable</asp:ListItem>
                                        <asp:ListItem >Replacement Purpose</asp:ListItem>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtInwardDate" runat="server" CssClass="datetext" type="datepic" EnableTheming="False"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtDeliveryChallanNo" runat="server" ReadOnly="True">
                                        ...
                                        Text="*"> </asp:Label>
                                    <asp:RequiredFieldValidator ID="rfvDCNo" runat="server" ControlToValidate="txtDeliveryChallanNo"
                                            ErrorMessage="Please Enter the Delivery Challan No">*</asp:RequiredFieldValidator>
                                    <asp:Label ID="lblDC_ID_2" runat="server" Visible="false"></asp:Label>
                                </td>
                                <td style="text-align: right;">
                                    <asp:Label ID="Label6" runat="server" Text="Delivery Challan Date"></asp:Label></td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtDeliveryChallanDate" runat="server" type="datepic" CssClass="datetext" EnableTheming="False">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtLRDate" runat="server" CssClass="datetext" type="datepic" EnableTheming="False"></asp:TextBox>&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
                ...
                <tr>
                    <td colspan="4" style="width: 1242px">&nbsp;&nbsp;<asp:Button ID="btnForApproveHidden" runat="server" CausesValidation="False"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" id="Table4" runat="server"
                            ...
                            <tr>
                                <td style="text-align: left;">&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                                    <asp:Label ID="lblErrorItemCode" runat="server"></asp:Label>
                                </td>
                            </tr>
                        </table>
