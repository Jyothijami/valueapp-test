<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/InventoryMP1.master" Async="true" AutoEventWireup="true" CodeFile="DeliveryChallanDetails2.aspx.cs" Inherits="Modules_Inventory_DeliveryChallanDetails" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="pagehead">
                <tr>
                    <td class="pagehead" align="right" style="text-align: left;">Delivery Challan Details
                        <asp:Label ID="lblErrorItemCode" runat="server" Visible="false"></asp:Label>
                    </td>
                </tr>
            </table>
                    ...
                    <td colspan="4" style="width: 1242px">
                        <table id="tblAssignTasks" runat="server" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <asp:Label ID="Label10" runat="server" Text="Delivery Challan Date"></asp:Label></td>
                                <td style="text-align: left; height: 24px;">
                                    <asp:TextBox ID="txtDeliveryDateForAssign" runat="server" ReadOnly="True" type="datepic" Enabled="false"></asp:TextBox>&nbsp;
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right;">
                ...
                <tr>
                    <td colspan="4" style="width: 1242px">
                        <table border="0" cellpadding="0" cellspacing="0" id="tblDCDetails" runat="server"
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Label ID="Label51" runat="server" Text="Select Nick Name"></asp:Label></td>
                                <td style="width: 362px; text-align: left">
                                    ...
                                    <asp:DropDownList ID="ddlUnitName" runat="server" Enabled ="false"  AutoPostBack="True" EnableTheming="False" OnSelectedIndexChanged="ddlUnitName_SelectedIndexChanged" Width="200px">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server"
                                        ControlToValidate="ddlUnitName" ErrorMessage="Please Select UnitName"
                                ...
                                <td colspan="4" style="text-align: center;">
                                    <asp:GridView ID="gvDeliveryChallanItems" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DC_ID" HeaderText="DC_ID"></asp:BoundField>
                                        </Columns>
                                        <EmptyDataTemplate>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 332px;">
                                    <asp:TextBox ID="txtDeliveryChallanDate" runat="server" CssClass="datetext" type="datepic" EnableTheming="False">
                                    </asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align: right; width: 192px; height: 40px;">
                                    <asp:Label ID="Label32" runat="server" Text="DC  No"></asp:Label></td>
                                ...
                                <td style="text-align: left; width: 332px; height: 40px;">
                                    <asp:TextBox ID="txtLRDate" runat="server" CssClass="datetext" type="datepic" EnableTheming="False"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right; width: 192px;"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" style="text-align: left">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server"
                                                            ControlToValidate="ddlLocation" ErrorMessage="Please Select Location" ValidationGroup="ip"
                                                            InitialValue="0">*</asp:RequiredFieldValidator>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="gvReservedStock" runat="server" AutoGenerateColumns="False" Width="100%"
                                                            OnRowDataBound="gvReservedStock_RowDataBound">
                                                            <Columns>
