...
using vllib;
public partial class Modules_Inventory_InternalOrderApproval : basePage
{
    ...
    protected void lbtnWorkOrderNo_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("InternalOrderApprovalDetails.aspx?WoNo=" + gvWorkOrderDetails.SelectedRow.Cells[0].Text);
