...
public partial class Modules_Inventory_DeliveryChallanDetails : basePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlCompany.SelectedValue = cp.getPresentCompanySessionValue();
            ...
            if (Request.QueryString["DcId"] != null)
            {
                try
                {
                    ...
                    if (objDelivery.Delivery_Select(Request.QueryString["DcId"].ToString()) > 0)
                    {
                        ...
                        // objDelivery.DeliveryDetails_Select(ddlSalesOrderNo.SelectedItem.Value, gvDeliveryChallanItems);
    ...
    private void setControlsVisibility()
    {
        ...
        btnDeleteItem.Enabled = up.Delete;
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (btnSave.Text == "Save")
        {
            ...
            //"alert(' Data Saved sucessfully');window.location ='DeliveryChallan.aspx';", true);
        ...
        else if (btnSave.Text == "Update")
        {
            ...
            //Response.Redirect("DeliveryChallan.aspx");
            //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
            //"alert(' Data Updated sucessfully');window.location ='DeliveryChallan.aspx';", true);
        ...
        if (gvItmDetails.Rows.Count > 0)
        {
            try
            {
                ...
                if (objInventory.Delivery_Save() == "Data Saved Successfully")
                {
                    ...
                    foreach (GridViewRow gvrow in gvItmDetails.Rows)
                    {
                        ...
                        {
                            #region Stock Outward
                            int qty = int.Parse(gvrow.Cells[6].Text);
                            int qty1 = int.Parse(gvrow.Cells[6].Text);
                            #region Block Release

                            string Itemcode = gvrow.Cells[2].Text;
                            SqlCommand cmd2 = new SqlCommand("Usp_DCBlocked_Items_New", con);
                            cmd2.CommandType = CommandType.StoredProcedure;
                            cmd2.Parameters.AddWithValue("@ItemCode", gvrow.Cells[2].Text);
                            cmd2.Parameters.AddWithValue("@ColorId", gvrow.Cells[11].Text);
                            cmd2.Parameters.AddWithValue("@CustId", Convert.ToInt32(lblCustId.Text));
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int i = 0; i < qty1; i++)
                                {
                                    ...
                                    cmd1.Parameters.AddWithValue("@CustId", lblCustId.Text);
                                    cmd1.Parameters.AddWithValue("@LocId", dt2.Rows[i][3]);
                                    cmd1.Parameters.AddWithValue("@DeliveryDate", dt2.Rows[i][2]);
                                    con.Open();
                            ...
                            #region Outward
                            int qty2 = int.Parse(gvrow.Cells[6].Text);
                            ...
                            if (dt.Rows.Count > 0)
                            {
                                for (int i = 0; i < qty1; i++)
                                {
                                    ...
                                    if (qty2 >= Convert.ToInt32(dt.Rows[i][4]))
                                    {
                                        objout.qty = dt.Rows[i][4].ToString();
                                    }
                                    else if (qty2 < Convert.ToInt32(dt.Rows[i][4]))
                                    {
                                        objout.qty = qty2.ToString();
                                    }
                                    ...
                                    qty2 = qty2 - Convert.ToInt32(dt.Rows[i][4]);
                                    if (qty2 <= 0)
                                    {
                                        break;
                                    }
                    ...
                    foreach (GridViewRow gvrow in gvItmDetails.Rows)
                    {
                        ...
                        cmd2.Parameters.AddWithValue("@ColorId", gvrow.Cells[11].Text);
                        cmd2.Parameters.AddWithValue("@CustId", lblCustId.Text);
                        SqlDataAdapter da2 = new SqlDataAdapter(cmd2);
                        DataTable dt2 = new DataTable();
                        da2.Fill(dt2);
                        int qty = int.Parse(gvrow.Cells[6].Text);
                ...
                if (flag == 1)
                {
                    foreach (GridViewRow gvrow in gvItmDetails.Rows)
                    {
                        OutwardItems_Delete(Convert.ToInt32(objInventory.DCId), Convert.ToInt32(lblCustId.Text), Convert.ToInt32(gvrow.Cells[2].Text), Convert.ToInt32(gvrow.Cells[11].Text), Yantra.Classes.General.toMMDDYYYY(DateTime.Now.ToString("dd/MM/yyyy")));
                    }
            ...
            finally
            {
                ...
                if (flag != 1)
                {
                    ...
                    Inventory.ClearControls(this);
                    Inventory.Dispose();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert(' Data Saved sucessfully');window.location ='DeliveryChallan.aspx';", true);
                }
                //else if (flag == 2)
                //{
                ...
                {
                    string error = "Model No." + lblErrorItemCode.Text + "Problem with Updating the Stock. Please Contact the Admin!.";
                    MessageBox.Show(this, error);
                }
                else
                {
    ...
    private void DeliveryUpdate()
    {
        ...
        {
            MessageBox.Show(this, "You can not update one company DC to another, Please contact Admin");
        }
        else
        {
            #region Update DC Data
        ...
        if (gvItmDetails.Rows.Count > 0)
        {
                ...
                foreach (GridViewRow gvrow in gvItmDetails.Rows)
                {
                    ...
                    if (count <= 0)
                    {
                        ...
                        if (objInventory.DeliveryDetails_Save() == "Data Saved Successfully")
                        {
                            ...
                            cmd2.Parameters.AddWithValue("@ColorId", gvrow.Cells[11].Text);
                            cmd2.Parameters.AddWithValue("@CustId", Convert.ToInt32(lblCustId.Text));
                            //cmd2.Parameters.AddWithValue("@LocId", gvrow.Cells[11].Text);
                            SqlDataAdapter da2 = new SqlDataAdapter(cmd2);
                            DataTable dt2 = new DataTable();
                            da2.Fill(dt2);
                            int remQty = 0;
                            ...
                            if (dt.Rows.Count > 0)
                            {
                                for (int i = 0; i < qty1; i++)
                                {
                                    ...
                                    //objout.companyid = lblCPID.Text;
                                    objout.companyid = dt.Rows[i][3].ToString();
                                    objout.DCID = Request.QueryString["DcId"];
                                    //objout.COLORID = gvrow.Cells[11].Text;
                                    objout.COLORID = dt.Rows[i][2].ToString();
                                    objout.CustId = lblCustId.Text;
                                    objout.OutwardNew_Save();
                            ...
                            {
                                //MessageBox.Show(this, "There is a problem with Updating the Stock, Please Contact the Admin;");
                                lblErrorItemCode.Text = gvrow.Cells[3].Text;
                                Error = 1;
                                break;
                            }
            ...
            finally
            {
                ...
                if (flag != 1 && Exists != 1)
                {
                    ...
                    Inventory.ClearControls(this);
                    Inventory.Dispose();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert","alert(' Data Updated sucessfully');window.location ='DeliveryChallan.aspx';", true);
    ...
    protected void ddlSalesOrderNo_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (objSM.SalesOrder_Select(ddlSalesOrderNo.SelectedItem.Value) > 0)
            {
                ...
                // Inventory.Delivery objDelivery1 = new Inventory.Delivery();
                ...
                SM.CustomerMaster.CustomerNickName_Select(ddlNickName, objSM.CustId);
    ...
    protected void ddlModelNo_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (GridViewRow porow in gvItemDetails.Rows)
            {
                if (porow.Cells[3].Text == ddlModelNo.SelectedItem.Text)
                {
                    txtBalanceQty.Text = porow.Cells[15].Text;
    ...
    protected void lbtnDCNo_Click(object sender, EventArgs e)
    {
        ...
        lblColorId.Text = gvDeliveryChallanItems.SelectedRow.Cells[14].Text;
        ...
        lblDCid.Text = gvDeliveryChallanItems.SelectedRow.Cells[15].Text;
    }
    ...
    private void Outward_Delete()
    {
        ...
        int qty1 = Convert.ToInt32(lblQty.Text);
        //SqlCommand cmd = new SqlCommand("delete top (" + i + ") from [OUTWARD] where [ITEM_CODE]=" + lblDCItemCode.Text + " and CUSTOMERID=" + lblCustId.Text + "", con);
        //    con.Open();
        //    cmd.ExecuteNonQuery();
        //    con.Close();
        ////}
        ...
        string Itemcode = lblDCItemCode.Text;
    ...
    protected void btnDelete_Click1(object sender, EventArgs e)
    {
        foreach (GridViewRow gvrow in gvDeliveryChallanItems.Rows)
        {
            ...
            MessageBox.Show(this, "DC Deleted Successfully");
    ...
    {
        SqlCommand cmd = new SqlCommand("delete  from [OUTWARD_NEW] where PO_NO=" + Request.QueryString["DcId"] + "", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void btnSendSMS_Click(object sender, EventArgs e)
    {
        ...
        //string msgEmp = "Dear " + txtCustomerName.Text + ", your material has been dispatched from Valueline on " + dt + " via " + txtDeliveryChallanNo.Text + ". Any Enquiry contact No.8008103075.";
        // string Cust_MNo = "8712349179";
        string CustomerName = ddlUnitName.SelectedItem.Text;
        string msgEmp = "Dear " + CustomerName + ", your material has been dispatched from Valueline on " + dt + " via " + txtDeliveryChallanNo.Text + ". Any Enquiry contact No.8008103075.";
