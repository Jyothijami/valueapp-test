...
using vllib;
public partial class Modules_Inventory_PaymentDetails : basePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["AMCPR_ID"] != null)
            {
                ...
                try
                {
                    ...
                    if (objPaymentsReceived.AMCPaymentsReceived_Select(Request.QueryString["AMCPR_ID"].ToString()) > 0)
                    {
                        btnSave.Text = "Update";
    ...
    private void PaymentsReceivedUpdate()
    {
        ...
        try
        {
            ...
            objPaymentsReceived.AMCPRId = Request.QueryString["AMCPR_ID"].ToString();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        if (Request.QueryString["AMCPR_ID"] != null)
        {
            try
            {
                ...
                MessageBox.Show(this, objPaymentsReceived.AMCPaymentsReceived_Delete(Request.QueryString["AMCPR_ID"].ToString()));
