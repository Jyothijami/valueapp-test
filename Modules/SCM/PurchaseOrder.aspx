<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/PurchaseMP1.master" AutoEventWireup="true" CodeFile="PurchaseOrder.aspx.cs" Inherits="Modules_SCM_PurchaseOrder" %>
       ...
       <%-- function DueAmt() {
        ...
        $(document).ready(function () {
            ...
            $(document).on("keyup", "[id$='txtPackingCharges'],[id$='txtFobCharges'],[id$='txtCifCharges'],[id$='txtTaxes'],[id$='txtInsurance'],[id$='txtFreight']", function () {
                ...
                var Per = parseFloat($("[id$='txtTaxes']").val(), 10) || 0;
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="tblPurchaseOrder" runat="server"
            ...
            <td colspan="4" style="text-align: left">
                <table border="0" cellpadding="0" cellspacing="0" id="Table4" runat="server" visible="true"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtItemDate" type="date" runat="server"></asp:TextBox>
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            <tr style="background-color:#98b7e9"><td style="width:42%"></td>
                                ...
                                <td style="width:8%;color:black;font-weight:bold">
                                    Total Amount :
                                </td>
                                <td style="width:10%;color:red;font-weight:bold">
        ...
        <tr>
         ...
         <tr>
                ...
                <tr>
                                <td style="text-align: right">Taxes-CST :
                                </td>
                                <td style="text-align: left">
