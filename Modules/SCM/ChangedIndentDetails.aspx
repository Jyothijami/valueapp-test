<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/InventoryMP1.master" AutoEventWireup="true" CodeFile="ChangedIndentDetails.aspx.cs" Inherits="Modules_SCM_ChangedIndentDetails" %>
                        ...
                        <td colspan="3" style="text-align: center">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:DropDownList ID="ddlOrderAcceptance" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOrderAcceptance_SelectedIndexChanged" EnableTheming="False">
                                        </asp:DropDownList></td>
                                </tr>
                            </table>
