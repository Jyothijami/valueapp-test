...
public partial class Modules_SCM_SalesReturn : basePage
{
            ...
            try
            {
                ...
                if (objInventory.SalesReturn_Save() == "Data Saved Successfully")
                {
                    ...
                    foreach (GridViewRow gvrow in gvsales.Rows)
                    {
                        ...
                        //obj1.iqitemcode = gvrow.Cells[2].Text;
                        //obj1.iqcpid = gvrow.Cells[16].Text;
                        //obj1.iqgodownid = gvrow.Cells[15].Text;
                        //obj1.iqcolorid = gvrow.Cells[14].Text;
                        //obj1.iqitemqtyinhand = gvrow.Cells[6].Text;
                        ////obj.iqresqty = "0";
                        //obj1.ItemMaster_UpdateStock();
    ...
    private void SalesReturnUpdate()
    {
        if (gvsales.Rows.Count > 0)
        {
            try
            {
                ...
                objInventory.SRId = gvSalesReturnDetails.SelectedRow.Cells[0].Text;
                objInventory.SRNo = txtSalesReturnNo.Text;
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Inventory.BeginTransaction();
            objSI.SRId = gvSalesReturnDetails.SelectedRow.Cells[0].Text;
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        if (gvSalesReturnDetails.SelectedIndex > -1)
        {
            try
            {
                string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=SalesReturn&Srno=" + gvSalesReturnDetails.SelectedRow.Cells[0].Text + "";
    ...
    {
        Response.Redirect("SalesReturnDetails.aspx");
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SalesReturnDetails.aspx?SrNo=" + gvSalesReturnDetails.SelectedRow.Cells[0].Text);
        ...
        if (gvSalesReturnDetails.SelectedIndex > -1)
        {
            try
            {
                ...
                if (objInventory.SalesReturn_Select(gvSalesReturnDetails.SelectedRow.Cells[0].Text) > 0)
                {
                    btnSave.Text = "Update";
                    btnSave.Enabled = true;
                    tblsr.Visible = true;
                    ...
                    objInventory.SalesReturnDetails_Select(gvSalesReturnDetails.SelectedRow.Cells[0].Text, gvItmDetails);
                }
            }
            catch (Exception ex)
            {
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        if (gvSalesReturnDetails.SelectedIndex > -1)
        {
            ...
            {
                Inventory.SalesReturn objInventory = new Inventory.SalesReturn();
                MessageBox.Show(this, objInventory.SalesReturn_Delete(gvSalesReturnDetails.SelectedRow.Cells[0].Text));
            }
            catch (Exception ex)
            {
                MessageBox.Show(this, ex.Message);
    ...
    protected void lbtnSalesReturnNo_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (objInventory.SalesReturn_SelectOri(gvSalesReturnDetails.SelectedRow.Cells[0].Text) > 0)
            {
                btnSave.Text = "Update";
    ...
    protected void btnSearchGo_Click(object sender, EventArgs e)
    {
        ...
        if (ddlSearchBy.SelectedItem.Text == "Sales Return Date")
        {
    ...
    {
        gvSalesReturnDetails.PageSize = Convert.ToInt32(ddlNoOfRecords.SelectedValue);
        gvSalesReturnDetails.DataBind();
    }
}
