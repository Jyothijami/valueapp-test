...
using vllib;
public partial class Modules_SCM_IndentApprovalList : basePage
{
    #region PAGE LOAD
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                // ddlIndentNo.SelectedValue = Request.QueryString["indid"].ToString();
    ...
    protected void lbtnIndentApprovalNo_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (objIndentApproval.IndentApproval_Select(gvIndentApprlDetails.SelectedRow.Cells[0].Text) > 0)
            {
                btnSave.Text = "Update";
                ...
                objIndentApproval.IndentApprovalDetails_Select(gvIndentApprlDetails.SelectedRow.Cells[0].Text, gvApprlItemDetails);
            }
        }
        catch (Exception ex)
        {
    ...
    {
        string str = "New";
        Response.Redirect("IndentApprovedListNew.aspx?IndentId=" +str);
    ...
    private void IndentApprovalUpdate()
    {
        if (gvApprlItemDetails.Rows.Count > 0)
        {
            try
            {
                ...
                objSCM.INDAPPRLId = gvIndentApprlDetails.SelectedRow.Cells[0].Text;
                objSCM.INDAPPRLNo = txtApprovalNo.Text;
                objSCM.INDAPPRLDate = Yantra.Classes.General.toMMDDYYYY(txtIndentApprovalDate.Text);
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("IndentApprovedListNew.aspx?IndentId" + gvIndentApprlDetails.SelectedRow.Cells[0].Text);
        //    try
        //    {
        //        SCM.IndentApproval objIndentApproval = new SCM.IndentApproval();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        if (gvIndentApprlDetails.SelectedIndex > -1)
        {
            ...
            {
                SCM.IndentApproval objSCM = new SCM.IndentApproval();
                MessageBox.Show(this, objSCM.IndentApproval_Delete(gvIndentApprlDetails.SelectedRow.Cells[0].Text));
            }
            catch (Exception ex)
            {
                MessageBox.Show(this, ex.Message);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        if (gvIndentApprlDetails.SelectedIndex > -1)
        {
            try
            {
                string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=IndentApproval&indapprlno=" + gvIndentApprlDetails.SelectedRow.Cells[0].Text + "";
    ...
    protected void btnsuppliersEnq_Click(object sender, EventArgs e)
    {
        if (gvIndentApprlDetails.SelectedIndex > -1)
        {
            Response.Redirect("SuppliersEnquiry.aspx?SeId=" + gvIndentApprlDetails.SelectedRow.Cells[0].Text + "");
        }
        else
        {
    ...
    protected void ddlSearchBy0_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlSearchBy0.SelectedItem.Text == "IND DATE" || ddlSearchBy0.SelectedItem.Text == "Req By Date")
        {
            ddlSymbols0.Visible = true;
            imgToDate0.Visible = true;
            ceSearchValueToDate0.Enabled = true;
         //   MaskedEditSearchToDate0.Enabled = true;
        }
        else
        {
            ddlSymbols0.Visible = false;
            imgToDate0.Visible = false;
            ceSearchValueToDate0.Enabled = false;
         //   MaskedEditSearchToDate0.Enabled = false;
            txtSearchValueFromDate0.Visible = false;
            lblCurrentFromDate0.Visible = false;
            lblCurrentToDate0.Visible = false;
            imgFromDate0.Visible = false;
            ceSearchFrom0.Enabled = false;
         //   MaskedEditSearchFromDate0.Enabled = false;
            ddlSymbols0.SelectedIndex = 0;
        }
        txtSearchText0.Text = string.Empty;
    }
    protected void ddlSymbols0_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlSymbols0.SelectedItem.Text == "R")
        {
            txtSearchValueFromDate0.Visible = true;
            lblCurrentFromDate0.Visible = true;
            lblCurrentToDate0.Visible = true;
            imgFromDate0.Visible = true;
            ceSearchFrom0.Enabled = true;
           // MaskedEditSearchFromDate0.Enabled = true;
        }
        else
        {
            txtSearchValueFromDate0.Visible = false;
    ...
    protected void btnSearchGo0_Click(object sender, EventArgs e)
    {
        gvIndentDetails.SelectedIndex = -1;
        lblSearchItemHidden0.Text = ddlSearchBy0.SelectedValue;
        lblSearchTypeHidden0.Text = ddlSymbols0.SelectedValue;
        if (ceSearchFrom0.Enabled == false) { lblSearchValueFromHidden0.Text = txtSearchValueFromDate0.Text; }
        else if (ceSearchFrom0.Enabled == true) { lblSearchValueFromHidden0.Text = Yantra.Classes.General.toMMDDYYYY(txtSearchValueFromDate0.Text); }
        if (ceSearchValueToDate0.Enabled == false) { lblSearchValueHidden0.Text = txtSearchText.Text; }
        else if (ceSearchValueToDate0.Enabled == true) { lblSearchValueHidden0.Text = Yantra.Classes.General.toMMDDYYYY(txtSearchText0.Text); }
        gvIndentDetails.DataBind();
    }
}
