<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/PurchaseMP1.master" AutoEventWireup="true" CodeFile="PurchaseOrder1.aspx.cs" Inherits="Modules_SCM_PurchaseOrder" %>
            ...
            <td colspan="4" style="text-align: left">
                <table border="0" cellpadding="0" cellspacing="0" id="Table1" runat="server" visible="true"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:TextBox ID="txtPODate" type="datef" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Fright%" ControlStyle-Width="50px" >
                                        <ItemTemplate >
                                            <asp:TextBox ID="txtFright" runat="server" Text='<%# Bind("Fright") %>'  AutoPostBack ="true" OnTextChanged ="txtFright_TextChanged"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Insurance%" ControlStyle-Width="50px" >
                                        <ItemTemplate >
                                            <asp:TextBox ID="txtInsurance" runat="server" Text='<%# Bind("Insurance") %>'  AutoPostBack ="true" OnTextChanged ="txtInsurance_TextChanged"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Total" ControlStyle-Width="70px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotal"  Text='<%# Bind("Amount") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="GST%" ControlStyle-Width="50px" >
                                        <ItemTemplate >
                                    ...
                                    <asp:TemplateField HeaderText ="GST Amount" ControlStyle-Width="70px">
                                        <ItemTemplate >
                                            <asp:Label ID="lblGSTAmount" Text='<%# Bind("GSTAmount") %>'  runat="server"  ></asp:Label>
