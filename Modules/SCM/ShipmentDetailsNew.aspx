<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/PurchaseMP1.master" AutoEventWireup="true" CodeFile="ShipmentDetailsNew.aspx.cs" Inherits="Modules_SCM_ShipmentDetailsNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <table id="tblDetails" runat="server" width="100%">
        <tr>
                ...
                <asp:Label ID="Label7" runat="server" Text="Select Brand" ></asp:Label></td>
                <td style="text-align: left">
            ...
            <td colspan="4">&nbsp;<asp:GridView ID="gvItemDetails" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                   ...
                   <asp:BoundField DataField="Amount" HeaderText="Amount"></asp:BoundField>
                    ...
                    <asp:BoundField DataField ="PI_DET_ID" HeaderText ="Det Id" />
                    <asp:TemplateField>
                                <HeaderTemplate>
        ...
        <tr>
                        <td class="profilehead" colspan="4" style="text-align: left; height: 12px;">Shipped Items</td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align: center;">
                            <asp:GridView ID="gvPIDetails" runat="server" AutoGenerateColumns ="false" Width="100%" OnRowDataBound ="gvPIDetails_RowDataBound" OnRowDeleting ="gvPIDetails_RowDeleting" SelectedRowStyle-BackColor="#c0c0c0" >
                                ...
                                <Columns >
                                  ...
                                  <asp:BoundField DataField ="PIID" HeaderText="PIIDHidden" />
                                    <asp:BoundField DataField ="PI_DET_ID" HeaderText="PI Det ID" />
                                    <asp:BoundField DataField ="SD_DET_ID" HeaderText ="DetId" />
        ...
        <tr>
                        <td style="text-align: center;" colspan="4">
                            <asp:GridView ID="gvItDetails" Width ="100%" runat="server" AutoGenerateColumns="False" OnRowDataBound ="gvItDetails_RowDataBound">
                                <Columns>
                                    <asp:CommandField ShowEditButton="True"></asp:CommandField>
                                    <asp:CommandField ShowDeleteButton="True"></asp:CommandField>
                                    <asp:BoundField DataField="ItemCode" HeaderText="ItemCode"></asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="Brand_Id" HeaderText="Brand Id"></asp:BoundField>
                                    <asp:BoundField DataField="PINO" HeaderText="PINO"></asp:BoundField>
                                    <asp:BoundField DataField="PI_ID" HeaderText="PI Id"></asp:BoundField>
                                    <asp:BoundField DataField="PI_DET_ID" HeaderText="PI Det Id"></asp:BoundField>
                                    </Columns> 
                                </asp:GridView> 
                            </td> 
            </tr> 
