...
using vllib;
public partial class Modules_SCM_CheckingFormat : basePage
{
    ...
    {
        //if (gvCheckForm.SelectedIndex > -1)
        //{
    ...
    {
        Response.Redirect("CheckingFormatDetails.aspx");
    ...
    private void CheckingFormaUpdate()
    {
        ...
        try
        {
            ...
            SCM.BeginTransaction();
            objchkf.CHKId = gvCheckForm.SelectedRow.Cells[0].Text;
    ...
    //        objchkf.CHKManufacturerName = ddlSupplierName.SelectedItem.Value;
    //        objchkf.CHKReceivedOn = Yantra.Classes.General.toMMDDYYYY(txtReceivedOn.Text);
    //        objchkf.CHKModel = ddlItemName.SelectedItem.Text;
    //        objchkf.CHKSerialNo = txtSerialNo.Text;
    //        objchkf.CHKPONo = txtSlpl.Text;
    //        objchkf.CHKPODate = Yantra.Classes.General.toMMDDYYYY(txtPODate.Text);
    //        objchkf.CHKInvoiceNo = txtSupplier.Text;
    //        objchkf.CHKInvoiceDate = Yantra.Classes.General.toMMDDYYYY(txtSupplierDate.Text);
    //        objchkf.CHKRemarks = txtRemarks.Text;
    //        objchkf.CHKPreparedBy = Yantra.Authentication.GetEmployeeInSession(Yantra.Authentication.Logged_EMP_Details.EmpUserName);
    //        if (ddlApprovedBy.SelectedItem.Value == "0")
    //        {
    //            objchkf.CHKApprovedBy = "";
    ...
    //        objchkf.ItemCode = ddlItemName.SelectedItem.Value;
    //        objchkf.CHKQty = txtQty.Text;
    //        objchkf.CHKGatepass = txtGatepass.Text;
    //        objchkf.CHKLrno = txtlrno.Text;
    //        objchkf.CHKCPID = ddlCompanyName.SelectedItem.Value;
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        if (gvCheckForm.SelectedIndex > -1)
        {
            Response.Redirect("CheckingFormatDetails.aspx?ChkId=" + gvCheckForm.SelectedRow.Cells[0].Text);
        }
        else
        {
        ...
        //LinkButton lbtnCheckingNo = (LinkButton)sender;
        //GridViewRow Row = (GridViewRow)lbtnCheckingNo.Parent.Parent;
        //gvCheckForm.SelectedIndex = Row.RowIndex;
        //Response.Redirect("CheckingFormatDetails.aspx?ChkId=" + gvCheckForm.SelectedRow.Cells[0].Text);
        ...
        if (gvCheckForm.SelectedIndex > -1)
        {
            ...
            {
                SCM.CheckingFormat objchkf = new SCM.CheckingFormat();
                if (objchkf.CheckingFormat_Select(gvCheckForm.SelectedRow.Cells[0].Text) > 0)
                {
                    btnSave.Text = "Update";
                    btnSave.Enabled = true;
                    tblCheckDetails.Visible = true;
                   ...
                   // txtSerialNo.Text = objchkf.CHKSerialNo;
                    ...
                    objchkf.ChekingFormatDetailsscm_Select(gvCheckForm.SelectedRow.Cells[0].Text, GridView1);
                    GridView1.DataBind();
                }
            }
            catch (Exception ex)
    ...
    {
        if (ddlSearchBy.SelectedItem.Text == "MRN Date" || ddlSearchBy.SelectedItem.Text == "Received On")
        {
    ...
    protected void gvCheckForm_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void lbtnCheckingNo_Click(object sender, EventArgs e)
    {
        LinkButton lbtnCheckNo = (LinkButton)sender;
        GridViewRow Row = (GridViewRow)lbtnCheckNo.Parent.Parent;
        gvCheckForm.SelectedIndex = Row.RowIndex;
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SCM.BeginTransaction();
            objCHK.CHKId = gvCheckForm.SelectedRow.Cells[0].Text;
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        if (gvCheckForm.SelectedIndex > -1)
        {
            try
            {
                string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=checkingformat&chkid=" + gvCheckForm.SelectedRow.Cells[0].Text + "";
