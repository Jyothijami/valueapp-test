...
using vllib;
public partial class Modules_SCM_SampleReturn : basePage
{
    ...
    {
        User_Permissions up = new User_Permissions(Session["vl_userid"].ToString(), "79");
  ...
  //  #endregion
    ...
    {
        Response.Redirect("SampleReturnNew.aspx");
        Inventory.ClearControls(this);
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        if (gvSalesReturnDetails.SelectedIndex > -1)
        {
            Response.Redirect("SampleReturnNew.aspx?dcNo=" + gvSalesReturnDetails.SelectedRow.Cells[0].Text);
            //try
            //{
            //    Inventory.SalesReturn objInventory = new Inventory.SalesReturn();
            ...
            //        objInventory.SalesReturnDetailsSample_Select(gvSalesReturnDetails.SelectedRow.Cells[0].Text, gvItmDetails);
            //    }
            //}
            //catch (Exception ex)
            //{
