...
public partial class Modules_my_outbox : System.Web.UI.Page
{
    ...
    {
        cate_str1 = "SELECT * from yantra_hr_Circular WHERE (yantra_hr_Circular.Company_Id In (55,56,57)) AND (yantra_hr_Circular.EMP_ID = 314) ORDER BY yantra_hr_Circular.CIR_DATE DESC";
        SqlCommand cmd = new SqlCommand(cate_str1, con);
        cmd.CommandType = CommandType.Text;
        cmd.Parameters.Add("@show2", SqlDbType.Bit).Value = true;
        cmd.Parameters.Add("@uid", SqlDbType.VarChar).Value = 314;
