...
public partial class Modules_Home_ChangePassword : basePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Cmd.Parameters.AddWithValue("@newuserName", Yantra.Authentication.GetEmployeeInSession(Yantra.Authentication.Logged_EMP_Details.EmpUserName));
            ...
            Cmd.Parameters.AddWithValue("@Current_Password", txtRetypeNewpassword.Text);
            ...
            if (RetValue.SqlValue.ToString() == "0")
            {
                MessageBox.Show(this, "Password has been Changed Successfully!");

            }
            else if (RetValue.SqlValue.ToString() == "1")
            {
                MessageBox.Show(this, " Please Recheck Passwords Entered ");
