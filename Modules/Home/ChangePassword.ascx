<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChangePassword.ascx.cs" Inherits="Custom_Controls_ChangePassword" %>
                            ...
                            <tr>
                                <td rowspan="1" style=" height: 21px; text-align: right">
                                    <%--<asp:Label ID="Label12" runat="server" CssClass="label" Font-Bold="False" Font-Names="Verdana"
                                        Font-Size="8pt" ForeColor="#000040" Text="Enter Old Password:"></asp:Label>--%>
                                    Enter Old Password:
                                </td>
                            ...
                            <tr>
                                <td rowspan="1" style=" text-align: right">
                                    <%--<asp:Label ID="Lbl_new" runat="server" CssClass="label" Font-Bold="False" Font-Names="Verdana"
                                        Font-Size="8pt" ForeColor="#000040" Text="Enter New Password:" Width="134px"></asp:Label>--%>
                                    Enter New Password:
                                </td>
...
<%--                                    <asp:Label ID="Label19" runat="server" CssClass="label" Font-Bold="False" Font-Names="Verdana"
                                        Font-Size="8pt" ForeColor="#000040" Text="Retype New Password:" Width="140px"></asp:Label>--%>
                                    Retype New Password:
                                </td>
                                <td colspan="3" rowspan="1" style="text-align: left">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtNewPass"
                                        ControlToValidate="txtRetypeNewpassword" ErrorMessage="Please Enter Correct Passoword">*</asp:CompareValidator>
