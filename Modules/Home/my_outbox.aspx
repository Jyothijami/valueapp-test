<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/AdminMP1.master" AutoEventWireup="true" CodeFile="my_outbox.aspx.cs" Inherits="Modules_my_outbox" %>
                                        ...
                                        <tr>
                                            <td style="width: 50%; text-align:left;">
                                                <asp:HyperLink ID="HyperLink1" runat="server"
                                                    NavigateUrl='<%# Eval("CIR_ID","~/Modules/Home/view_message.aspx?CIR_ID={0}") %>'
                                                    Text='<%# Eval("CIR_NO") %>' CssClass="message-link"></asp:HyperLink></td>
                                            <td style="text-align: right" width="40%">
                                                <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl='#'
                                                    Text='<%# getUserName(Eval("EMP_ID").ToString()) %>'></asp:HyperLink>
                                                &nbsp;|
