<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/AdminMP1.master" AutoEventWireup="true" CodeFile="view_TaskList.aspx.cs" Inherits="Modules_Home_view_message" %>
...
<Sequence>
	<EnableAction AnimationTarget="Button1" Enabled="false" />
        ...
        <tr>
            <td>
                <asp:DataList ID="DataList1" runat="server" DataKeyField="CIR_ID" DataSourceID="msgsds1"
                    Width="100%">
                    <ItemTemplate>
                        <table style="width: 100%; text-align:left;">
                            <tr>
                                <td style="text-align: left">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label8" runat="server" Text='<%# getulink(Eval("Dept_ID").ToString()) %>' Font-Bold="True"></asp:Label>
                                                <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Eval("Dept_ID") %>' />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="posted_dateLabel" runat="server"
                                                    Text='<%# get_date(Convert.ToDateTime(Eval("CIR_DATE"))) %>' CssClass="message-dt-time"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style2">
                            ...
                            <tr>
                                <td style="padding:20px;">
                                    <asp:Label ID="msgLabel" runat="server"
                                        Text='<%# Eval("DESCRIPTION").ToString().Replace("" + (char)13, "<br />" ) %>'></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
                </asp:DataList>
                <asp:SqlDataSource ID="msgsds1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SELECT * FROM [YANTRA_HR_CIRCULAR] WHERE ([CIR_ID] = @CIR_ID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="CIR_ID" QueryStringField="CIR_ID" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
