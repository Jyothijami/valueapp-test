<%@ Page Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true"
    ...
    Title="|| ValueApp : SM : Customer Information ||" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
                                ...
                                <tr>
                                    ...
                                    <td style="height: 25px">
                                        <asp:DropDownList ID="ddlSearchBy" runat="server" CssClass="textbox" AutoPostBack="True" OnSelectedIndexChanged="ddlSearchBy_SelectedIndexChanged" OnTextChanged="ddlSearchBy_TextChanged" meta:resourcekey="ddlSearchByResource1">
                                            ...
                                            <asp:ListItem Value ="CUST_MOBILE" meta:resourcekey="ListItemResource7" Text="Mobile No" ></asp:ListItem>
        ...
        <tr>
            <td style="text-align: center; width: 944px;" colspan="4">
                <asp:GridView ID="gvCustMasterDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    Width="100%" DataSourceID="sdsCustMaster" OnRowDataBound="gvCustMasterDetails_RowDataBound" meta:resourcekey="gvCustMasterDetailsResource1" AllowSorting="True">
                    <Columns>
                        <asp:BoundField DataField="CUST_NAME" HeaderText="CustNameHidden" meta:resourceKey="BoundFieldResource1"></asp:BoundField>
                        <asp:BoundField DataField="CUST_CODE" HeaderText="CustomerCode" SortExpression="CUST_CODE" meta:resourceKey="BoundFieldResource2">
                        ...
                        <asp:TemplateField HeaderText="CustomerName" SortExpression="CUST_NAME" meta:resourceKey="TemplateFieldResource1">
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Bind("CUST_NAME") %>' ID="TextBox1" SortExpression="CUST_NAME" meta:resourceKey="TextBox1Resource1"></asp:TextBox>
                            </EditItemTemplate>
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnCustMaster" OnClick="lbtnCustMaster_Click" ForeColor="#0066ff"  runat="server" Text="<%# Bind('CUST_NAME') %>" CausesValidation="False" __designer:wfdid="w2" meta:resourceKey="lbtnCustMasterResource1"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="CUST_COMPANY_NAME" HeaderText="CompanyName" SortExpression="CUST_COMPANY_NAME" meta:resourceKey="BoundFieldResource3">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>

                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="locname" HeaderText="Region" SortExpression="locname" meta:resourceKey="BoundFieldResource4">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>

                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="CUST_CONTACT_PERSON" HeaderText="ContactPerson" SortExpression="CUST_CONTACT_PERSON" meta:resourceKey="BoundFieldResource5">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="CUST_ADDRESS" HeaderText="CustomerAddress" SortExpression="CUST_ADDRESS" meta:resourceKey="BoundFieldResource6">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="CUST_EMAIL" HeaderText="Email" SortExpression="CUST_EMAIL" meta:resourceKey="BoundFieldResource7">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                        ...
                        <asp:BoundField DataField="CUST_STATUS" HeaderText="Status" SortExpression="CUST_STATUS" meta:resourceKey="BoundFieldResource9">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>

                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="CUST_MOBILE" HeaderText="Mobile No." SortExpression="CUST_MOBILE" meta:resourceKey="BoundFieldResource10">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>

                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField ="CUST_CORP_FAX"  DataFormatString = "{0:dd/MM/yyyy}" HeaderText ="Prepared Date" />
                    <asp:BoundField DataField ="CUST_CORP_EMAIL" HeaderText ="Updated By" />
                    </Columns>
                    <EmptyDataTemplate>
                        No Data Exist!
                ...
                <table id="Table1" align="center">
                    <tr>
                        <td>
                         ...
                         <td>
                            <asp:Button ID="btnArchitect" runat="server" OnClick="btnArchitect_Click" Text="Architect Master" /></td>

                    
                        <td>
                            <asp:Button ID="btnWalkin" runat ="server" OnClick ="btnWalkin_Click" Text ="WalkIn" />
                            <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" Text="Edit" Visible="false" CausesValidation="False" meta:resourcekey="btnEditResource1" /></td>
                        <td>
                            <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" Visible="false" Text="Delete"
                                CausesValidation="False" meta:resourcekey="btnDeleteResource1" /></td>
                        <td>
                                        <asp:Button ID="btnSalesLead" runat="server" Text="Sales Lead"
                                            CausesValidation="False" Visible="false" OnClick="btnSalesLead_Click" meta:resourcekey="btnSalesLeadResource1" /></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="4" style="text-align: center; width: 944px;">
                <table border="0" cellpadding="0" cellspacing="0" id="tblCustomerDetails" runat="server"
                    ...
                    <tr>
                        <td style="text-align: left; height: 15px;" class="profilehead" colspan="4">
                            Customer Details</td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:DropDownList id="ddlDear" runat="server" EnableTheming="False" Width="47px">
                                <asp:ListItem>Mr</asp:ListItem>
                                <asp:ListItem>Ms</asp:ListItem>
                                <asp:ListItem>M/s</asp:ListItem>
                            </asp:DropDownList><asp:TextBox ID="txtCustomerName" runat="server" meta:resourcekey="txtCustomerNameResource1"></asp:TextBox><asp:Label ID="Label8" runat="server" EnableTheming="False" ForeColor="Red"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:DropDownList ID="ddlIndustryType" runat="server" meta:resourcekey="ddlIndustryTypeResource1" Width="79px">
                            </asp:DropDownList>
                            <asp:Label ID="Label22" runat="server" EnableTheming="False" ForeColor="Red"
                                Text="*" meta:resourcekey="Label22Resource1"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtContactNo1" runat="server" meta:resourcekey="txtContactNo1Resource1"></asp:TextBox><asp:Label ID="Label11" runat="server" EnableTheming="False" ForeColor="Red"
                                ...
                                ErrorMessage="Please Enter the Phone No" meta:resourcekey="rfvContactNo1Resource1" Text="*" Visible="False"></asp:RequiredFieldValidator><cc1:filteredtextboxextender id="ftxtePhoneNo" runat="server"
                    ...
                    <tr>
                        ...
                        <td style="height: 19px; text-align: left; width: 319px;">
                        </td>
                    </tr>
                    <tr>
...
<SPAN style="COLOR: #ff0000">No Data to Dispaly</SPAN>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; height: 19px; width: 319px;">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align: center">
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
<ItemTemplate>
<asp:LinkButton id="lbtnUnitName" onclick="lbtnUnitName_Click" runat="server" Text='<%# Bind("UnitName") %>' CausesValidation="False" meta:resourceKey="lbtnUnitNameResource1" __designer:wfdid="w4"></asp:LinkButton> 
</ItemTemplate>
</asp:TemplateField>
