<%@ Page Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true"
    CodeFile="SalesQuotation - Copy.aspx.cs" Inherits="Modules_SM_SalesQuotation" Title="|| Value App : S&M : Sales Quotation ||" %>
            ...
            <td style="text-align: center">
                <asp:GridView ID="gvQuotationDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText ="Preview" HeaderStyle-CssClass ="text-center ">
                            <ItemTemplate >
                                <span class ="text-center ">
                                    <a runat ="server" href ='<%# "~/Modules/SM/Quot_Preview.aspx?Cid=" +Eval ("QUOT_ID") %>' onclick ="OpenPopupCenter(this.href,'newwindow',1000,800);return false;" >Preview</a>
                                </span>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
