<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" CodeFile="WalkIn1.aspx.cs" Inherits="MODULES_SM_WalkIn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
    ...
    <telerik:RadStyleSheetManager ID="RadStyleSheetManager1" runat="server">
        ...
        <div class="row">
            <telerik:RadGrid ID="RadGrid1"   runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteColumn="True" AutoGenerateEditColumn="True"   DataSourceID="SqlDataSource1" ShowGroupPanel="True" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" PageSize="20" CellSpacing="-1" GridLines="Both" Skin="Sunset">
                ...
                <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="ID" CommandItemDisplay="Top" Font-Size="Larger" BorderColor="Red">
                    ...
                    <telerik:GridGroupByExpression>
                        ...
                        <GroupByFields>
                            <telerik:GridGroupByField FieldName="Date" SortOrder="Descending"></telerik:GridGroupByField>
                        </GroupByFields>
                    </telerik:GridGroupByExpression>
                    <telerik:GridGroupByExpression>
                        <SelectFields>
                            <telerik:GridGroupByField FieldAlias="Billing_Name" FieldName="Billing_Name"></telerik:GridGroupByField>
                        </SelectFields>
                        <GroupByFields>
                            <telerik:GridGroupByField FieldName="Billing_Name"></telerik:GridGroupByField>
                        </GroupByFields>
                    </telerik:GridGroupByExpression>
                </GroupByExpressions>--%>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="Date" HeaderStyle-Font-Bold="true"  GroupByExpression ="Date name Group By Date" ItemStyle-Font-Bold="true" DataType="System.DateTime" HeaderText="Date" SortExpression="Date" UniqueName="Date">
                            <EditItemTemplate>
                        ...
                        <telerik:GridBoundColumn DataField="Billing_Name" FilterControlAltText="Filter Billing_Name column" GroupByExpression ="Billing_Name name Group By Billing_Name"  HeaderText="Billing_Name" SortExpression="Billing_Name" UniqueName="Billing_Name">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Phone"  FilterControlAltText="Filter Phone column" HeaderText="Phone" GroupByExpression ="Phone name Group By Phone" SortExpression="Phone" UniqueName="Phone">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Source" ItemStyle-Width="240px" GroupByExpression ="Source name Group By Source">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn DataField="InTime" HeaderStyle-Font-Bold="true" ItemStyle-Font-Bold="true" DataType="System.TimeSpan" HeaderText="InTime" SortExpression="InTime" UniqueName="InTime">
                            <EditItemTemplate>
                                <telerik:RadTimePicker RenderMode="Lightweight" ID="RadTimePicker1"  runat="server">
                                </telerik:RadTimePicker>
                            </EditItemTemplate>
                            <ItemTemplate >
                                <telerik:RadTimePicker RenderMode="Lightweight" ID="RadTimePicker2" runat="server"></telerik:RadTimePicker>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Attendent" ItemStyle-Width="240px" GroupByExpression ="AttendedBy name Group By AttendedBy">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Assisted" ItemStyle-Width="240px" GroupByExpression ="AssistedBy name Group By AssistedBy">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Backup Support" ItemStyle-Width="240px" GroupByExpression ="BackupSBy name Group By BackupSBy">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Additional Support" ItemStyle-Width="240px"  GroupByExpression ="AddBackupBy name Group By AddBackupBy">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Automation Explained" ItemStyle-Width="240px"  GroupByExpression ="Automation_Exp name Group By Automation_Exp">
                            <ItemTemplate>
