<%@ Page Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" Async="true"
    CodeFile="SalesOrder.aspx.cs" Inherits="Modules_SM_SalesOrder" Title="|| Value App : S&M : Sales Order ||" %>
            ...
            <td colspan="4">
                <asp:GridView ID="gvSalesOrderDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames ="SO_ID" OnRowCommand ="gvSalesOrderDetails_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField >
                            <ItemTemplate >
                                <asp:Button ID="btnAcceptence" runat="server" Text="Manual Close" CommandName ="Manual Close" CommandArgument='<%# Eval("SO_ID").ToString() %>'  Width="100px" />
                             </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField  >
                            <ItemTemplate >
                        ...
                        <td colspan="4" style="text-align: center">
                            <asp:UpdatePanel runat="server">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText ="Annexure Indent Qty">
                                        <ItemTemplate >
                                            <asp:TextBox ID="txtAnnexureQty" Text='<%#Bind("Annexure_Qty") %>' runat="server" ></asp:TextBox>
