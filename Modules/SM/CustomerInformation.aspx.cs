...
public partial class Modules_SM_CustomerInformation : basePage
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["CustId"] != null) 
            {
                ...
                if ((objSMCustomer.CustomerMaster_Select(CustId)) > 0)
                {
                    ...
                    //objSMCustomer.CustomerMasterDetails_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text, gvCustomerItems);
    ...
    private void setControlsVisibility()
    {
        ...
        //btnSalesLead.Enabled = up.SalesLead;
        //btnOtherCorpDetails.Enabled = up.OtherCorpDetails;
        //btnOtherCorpDetailsAdd.Enabled = up.OtherCorpDetailsAdd;
        //btnOtherCorpDetailsRefresh.Enabled = up.OtherCorpDetailsRefresh;
        //btnAddUnits.Enabled = up.AddUnits;
        //btnUnitsAdd.Enabled = up.UnitsAdd;
        //btnUnitsRefresh.Enabled = up.UnitsRefresh;
    ...
    private void CustomerMasterUpdate()
    {
        try
        {
            SM.CustomerMaster objMaster = new SM.CustomerMaster();
            SM.BeginTransaction();
            objMaster.CustId = gvCustMasterDetails.SelectedRow.Cells[8].Text;
            objMaster.CustCode = txtCustomerCode.Text;
            objMaster.RegId = ddlRegion.SelectedItem.Value;
            objMaster.CustName = txtCustomerName.Text;
    ...
    #region Link Button CustMaster_Click
    protected void lbtnCustMaster_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("CustomerInformation_Details.aspx?CustId=" + gvCustMasterDetails.SelectedRow.Cells[8].Text
        + "&CUST_NAME=" + gvCustMasterDetails.SelectedRow.Cells[1].Text);
        ...
        //UnitName_Fill(gvCustMasterDetails.SelectedRow.Cells[8].Text);

        //SM.CustomerMaster objSMCustomer = new SM.CustomerMaster();
        //if ((objSMCustomer.CustomerMaster_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text)) > 0)
        //{
        //    btnSave.Text = "Update";
        //    tblCustomerDetails.Visible = true;
        //    btnSave.Enabled = false;
        ...
        //    ddlDesignationNo.SelectedValue = objSMCustomer.DesgId;
        //    rbNewExisting.SelectedValue = objSMCustomer.IsNewOrExisting;
        //    ddlDear.SelectedItem.Value = objSMCustomer.cUSTdEAR;
        //    //txtCorpContactPerson.Text = objSMCustomer.CorpContactPerson;
        //    //ddlCorpDesignationNo.SelectedValue = objSMCustomer.CorpDesgId;
        //    //txtCorpAddress.Text = objSMCustomer.CorpAddress;
        //    //txtCorpContactNo1.Text = objSMCustomer.CorpPhone;
        ...
        //    objSMCustomer.CustomerMasterDetails_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text, "0", gvOtherCorpDetails);
        //    //objSMCustomer.CustomerMasterDetails_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text, gvCustomerItems);
        //    tdContactDetailsHead.Visible = tdUnitDetailsHead.Visible = true;
        //    gvCustomerItems.DataBind(); gvUnitDetails.SelectedIndex = -1;
        //    objSMCustomer.CustomerUnitDetails_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text, gvUnitDetails);
        //    btnOtherCorpDetails.Visible = btnAddUnits.Visible = false;
        //}
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
       ...
       //Old Code
        if (gvCustMasterDetails.SelectedIndex > -1)
        {
            SM.ClearControls(this);
            try
            {
                ...
                if ((objSMCustomer.CustomerMaster_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text)) > 0)
                {
                    ...
                    // objSMCustomer.CustomerMasterDetails_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text, Repeater1);
                }
            }
            catch (Exception ex)
            {
    ...
    protected void btnArchitect_Click(object sender, EventArgs e)
    {
        Response.Redirect("Architect.aspx");
    }
    ...
    {
        int n = 0;
        Response.Redirect("CustomerInformation_Details.aspx?hai");
        tblCustomerDetails.Visible = true;
        //Old Code
        try
        {
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        if (gvCustMasterDetails.SelectedIndex > -1)
        {
            try
            {
                string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=CustomerMaster&custcode=" + gvCustMasterDetails.SelectedRow.Cells[1].Text + "";
    ...
    protected void lbtnUnitName_Click(object sender, EventArgs e)
    {
        ...
        if (gvRowUnit.Cells[5].Text != "-")
        {
            ...
            objCust.CustomerMasterDetails_Select(gvCustMasterDetails.SelectedRow.Cells[8].Text, gvRowUnit.Cells[5].Text, gvCustomerItems);
        }
        else
        {
            gvCustomerItems.DataBind();
    ...
    {
        if (ddlSearchBy.SelectedItem.Text == "--")
        {
            txtSearchText.Text = "";
    ...
    #region Ddl Search By Text Changed
    ...
    protected void btnSalesLead_Click(object sender, EventArgs e)
    {
        ...
        if (gvCustMasterDetails.SelectedIndex > -1)
        {
            Response.Redirect("SalesEnquiryDetails.aspx?Cid=" + gvCustMasterDetails.SelectedRow.Cells[8].Text + "");
        }
        else
        {           
            MessageBox.Show(this, "Please Select atleast a Record ");
