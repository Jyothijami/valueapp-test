 <%@ Page Title="" Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" CodeFile="WorkOrderDetails.aspx.cs" Inherits="Modules_SM_WorkOrderDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <table id="tblWorkOrderDetails" runat="server"
        ...
        <tr>
            ...
            <td style="text-align: left;">
                <asp:TextBox ID="txtWODate" runat="server" CssClass="datetext" type="date" EnableTheming="False"></asp:TextBox><%--<asp:Image ID="imgWODate" runat="server" ImageUrl="~/Images/Calendar.png" />--%><asp:Label ID="Label10" runat="server" EnableTheming="False" ForeColor="Red" Text="*">
                </asp:Label>
        ...
        <tr>
            ...
            <td style="text-align: left;">
                <asp:TextBox ID="txtDeliveryDate" runat="server" CssClass="datetext" type="date" EnableTheming="False"></asp:TextBox><%--<asp:Image ID="imgDeliveryDate" runat="server" ImageUrl="~/Images/Calendar.png" />--%><asp:Label ID="Label16" runat="server" EnableTheming="False" ForeColor="Red" Text="*">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="btnReserve" runat="server" Text="Reserve" CausesValidation="False"
                                OnClick="btnReserve_Click" Visible="true" />
