<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyReportDoc1.aspx.cs" Inherits="Modules_SM_DailyReportDoc1" %>
            ...
            <div class="">
                <asp:GridView ID="gvFloorPlan" CssClass="table table-bordered" Width="100%" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DAILYREPORTDOC_ID" HeaderText="Sl.No" SortExpression="DAILYREPORTDOC_ID">
