...
public partial class Modules_SM_Architect : basePage
{
    ...
    private void CategorySave()
    {
        try
        {
            ...
            objMaster.OrgName = txtOrgName.Text;
            objMaster.ArchDesg = txtDesg.Text;
            objMaster.city = txtCity.Text;
            objMaster.pincode = txtPincode.Text;
    ...
    private void CategoryUpdate()
    {
        try
        {
            ...
            objMaster.UPLOAD1 = lblAtt.Text;
            objMaster.UPLOAD2 = lblAtt1.Text;
            if (objMaster.Architect_Update() == "Data Updated Successfully")
            {
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        if (gvArch.SelectedIndex > -1)
        {
            ...
            ddlCategory.SelectedItem .Text  = gvArch.SelectedRow.Cells[6].Text;
            txtPincode.Text  = gvArch.SelectedRow.Cells[8].Text;
            txtCity .Text  = gvArch.SelectedRow.Cells[7].Text;
