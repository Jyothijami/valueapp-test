<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" CodeFile="SalesQuotationDetails.aspx.cs" Inherits="Modules_SM_SalesQuotationDetails" %>
...
function summarycalc() {
    ...
    if (spdiscount != "" && spdiscount != "0") {
        ...
        ssubtotal = document.getElementById('<%=txtsubtotal.ClientID %>').value;
        document.getElementById('<%=txtsummaryvat.ClientID %>').value = parseFloat((((ssubtotal) * 14.5) / 100));
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="tblQuotationDetails" runat="server"
                ...
                <tr>
                    <td colspan="4" style="width: 100%">
                        <table class="stacktable">
                            ...
                            <tr>
                                <td style="text-align: right">
                                    <asp:Label ID="Label65" runat="server" Text="Vat 14.5% :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtsummaryvat" runat="server"></asp:TextBox>
                                </td>
                                <td style="text-align: right">
                                    <asp:Label ID="Label66" runat="server" Text="CST 2% :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtsummaryCst" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
                                    <asp:Label ID="Label67" runat="server" Text="GrandToal(VAT) :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtsummaryGtoalvat" runat="server"></asp:TextBox>
                                </td>
                                <td style="text-align: right">
                                    <asp:Label ID="Label1" runat="server" Text="GrandToal(CST) :"></asp:Label></td>
                                <td>
                                    <asp:TextBox ID="txtsummaryGtotalcst" runat="server"></asp:TextBox></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 357px;">
                        ...
                        <asp:RadioButton
                            ID="rbCST" runat="server" GroupName="vatcst" Text="C.S. Tax" /><asp:RadioButton
                                ID="rbincluding" runat="server" GroupName="vatcst" Text="Including" /></td>
                    ...
                    <td colspan="4" style="height: 49px">
                        <table id="tblButtons" border="0" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                ...
                                <td style="height: 24px">
                                    <asp:Button ID="btnPrintTB" runat="server" Text="Print T.B." OnClick="btnPrint_Click" CausesValidation="False" Visible="False" Width="100px" /></td>
                                <td style="height: 24px">
                                    <asp:Button ID="btnPrintCB" runat="server" Text="Print C.B." OnClick="btnPrint_Click" CausesValidation="False" Visible="False" Width="100px" /></td>
                                <td style="height: 24px">
