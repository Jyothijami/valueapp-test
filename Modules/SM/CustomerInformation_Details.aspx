<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" CodeFile="CustomerInformation_Details.aspx.cs" Inherits="Modules_SM_CustomerInformation_Details" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="tblCustomerDetails" runat="server"
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 319px;">
                        ...
                        <asp:Label ID="Label10" runat="server" EnableTheming="False" ForeColor="Red"
                            Text="*" meta:resourcekey="Label11Resource1" Visible="true"></asp:Label>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtEmail"
                                ErrorMessage="Please Enter the Email Id" meta:resourcekey="rfvContactNo1Resource1" Text="*" Visible="False" ValidationGroup="main"></asp:RequiredFieldValidator> 
                ...
                <tr>
                    <td colspan="4" style="text-align: center; height: 9px;">
                        <asp:Button ID="btnOtherCorpDetails" runat="server"  
                ...
                <tr>
                    <td colspan="4" style="text-align: center;">
                        <table border="0" cellpadding="0" cellspacing="0" id="tblUnitDetails" runat="server"
                            ...
                            <tr>
                                <td style="text-align: right">
                                    <asp:Label ID="Label24" runat="server" Text="Nick Name" Width="128px" meta:resourcekey="Label2Resource1"></asp:Label></td>
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtNickName" runat="server" EnableTheming="True" meta:resourcekey="txtUnitNameResource1"></asp:TextBox><asp:Label ID="Label28" runat="server" EnableTheming="False" ForeColor="Red" Text="*" meta:resourcekey="Label4Resource1"></asp:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtNickName"
                                        ErrorMessage="Please Enter the Unit Nick Name" ValidationGroup="unit" meta:resourcekey="RequiredFieldValidator1Resource1" Text="*"></asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
                        ...
                        <asp:GridView ID="gvUnitDetails" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvUnitDetails_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField ="Prepared_By" HeaderText ="Prepared By" />
                ...
                <tr>
                    <td class="profilehead" colspan="4" style="text-align: left">KYC &nbsp;Details</td>
                </tr>
                <tr>
                    <td style="text-align: right; height: 19px;"></td>
                    <td style="text-align: left; height: 19px;"></td>
                    ...
                    <td style="text-align: left; width: 319px;">
                        ...
                        <asp:DropDownList ID="ddlreference" runat="server">
                           <%-- <asp:ListItem Value ="Not Selected" >--</asp:ListItem>
                            ...
                            <asp:ListItem Value ="Interior Design" >Degital Media</asp:ListItem>
                            <asp:ListItem Value="Walk-In">Walk-In</asp:ListItem>
                            <asp:ListItem Value ="Old Customer" >Old Customer</asp:ListItem>
                            <asp:ListItem Value ="Builder" >Builder</asp:ListItem>
                            <asp:ListItem Value ="Interior Design" >Interior Design</asp:ListItem>--%>
                        </asp:DropDownList>
                        ...
                        <asp:DropDownList ID="ddlbudjet" runat="server">
                         ...
                         &nbsp;<asp:Label ID="Label14" runat="server" EnableTheming="False" Font-Bold="False"
                                                    Font-Names="Verdana" Font-Size="Smaller" ForeColor="Red" Text="*"></asp:Label>&nbsp;<asp:RequiredFieldValidator
                                                        ID="RequiredFieldValidator11" runat="server" ControlToValidate="ddlbudjet"
                                                        ErrorMessage="Please Enter the Reference Type" InitialValue="0" ValidationGroup="main">*</asp:RequiredFieldValidator>
                    ...
                    <td style="text-align: left; width: 319px;">
                        ...
                        <asp:DropDownList ID="ddlfollowup" runat="server">
                         ...
                         &nbsp;<asp:Label ID="Label15" runat="server" EnableTheming="False" Font-Bold="False"
                                                    Font-Names="Verdana" Font-Size="Smaller" ForeColor="Red" Text="*"></asp:Label>&nbsp;<asp:RequiredFieldValidator
                                                        ID="RequiredFieldValidator14" runat="server" ControlToValidate="ddlfollowup"
                                                        ErrorMessage="Please Enter the Reference Type" InitialValue="0" ValidationGroup="main">*</asp:RequiredFieldValidator>
               ...
               <tr>
                   ...
                   <td>
                        <asp:CheckBoxList ID="CheckBoxList1" Width="100%" runat="server" AutoPostBack="True" 
                             RepeatColumns="7" RepeatDirection="Horizontal" OnSelectedIndexChanged ="CheckBoxList1_SelectedIndexChanged">
                                    </asp:CheckBoxList>
...
<%--                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SELECT [ITEM_CATEGORY_ID], [ITEM_CATEGORY_NAME] FROM [YANTRA_LKUP_ITEM_CATEGORY]"></asp:SqlDataSource>--%>
                       ...
                       <asp:Label ID="lblLstselect" runat ="server" Text ="Please Select Required Multiple Brands By Clicking Ctrl + Mouse Click" Font-Bold="True" ForeColor="Red" EnableTheming="False" ></asp:Label>
                   </td>
                   <td style="text-align: right">
                    ...
                    <td style="text-align: left">
                        <%--<asp:TextBox ID="txtFAXNo" runat="server" meta:resourcekey="txtFAXNoResource1"></asp:TextBox>--%>
                         ...
                         &nbsp;<asp:Label ID="Label20" runat="server" EnableTheming="False" Font-Bold="False"
                                                    Font-Names="Verdana" Font-Size="Smaller" ForeColor="Red" Text="*"></asp:Label>&nbsp;<asp:RequiredFieldValidator
                                                        ID="RequiredFieldValidator15" runat="server" ControlToValidate="ddlrequirement"
                                                        ErrorMessage="Please Enter the Reference Type" InitialValue="0" ValidationGroup="main">*</asp:RequiredFieldValidator>
                    ...
                    <td colspan="4" style="height: 49px">
                        <table id="tblButtons" align="center">
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnShow" runat ="server" OnClick ="btnShow_Click" Text ="Activity Detials" CausesValidation ="false" />
                ...
                <tr>
                    <td colspan="4" >
                        <asp:GridView ID="gvTrig" Visible ="false"  runat ="server" DataSourceID ="SqlDataSource1" >

                        </asp:GridView>
                        <asp:GridView ID="gvTrigDet" Visible ="false" runat ="server" DataSourceID ="SqlDataSource2">

                        </asp:GridView>
                        <asp:SqlDataSource ID ="SqlDataSource1" runat="server"  ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="Select * from [Trig_CUSTOMER_UNITS] where Cust_ID=@CustHID" >
                            <SelectParameters>
                                                        <asp:ControlParameter ControlID="lblCustId" DefaultValue="0" Name="CustHID" PropertyName="Text" />
                                                    </SelectParameters>
                        </asp:SqlDataSource>
                         <asp:SqlDataSource ID ="SqlDataSource2" runat="server"  ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="Select * from [Trig_CUSTOMER_Det] where Cust_ID=@CustHID" >
                            <SelectParameters>
                                                        <asp:ControlParameter ControlID="lblCustId" DefaultValue="0" Name="CustHID" PropertyName="Text" />
                                                    </SelectParameters>
                        </asp:SqlDataSource>
