<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile ="~/MPs/SalesMP1.master" CodeFile="FPS.aspx.cs" Inherits="Modules_SM_FPS" %>
                    ...
                    <h6 class="panel-title">Sales Order Details</h6>
                        ...
                        <div class="panel-body">
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                     <asp:DropDownList ID="ddlQuotationNo" CssClass ="form-control" runat="server" OnSelectedIndexChanged="ddlQuotationNo_SelectedIndexChanged"
                                     AutoPostBack="True" Enabled="False"></asp:DropDownList>
                                 </div>
                                 <label class="col-sm-2 control-label text-right">Quotation Date</label>
                                 <div class="col-sm-4">
                                    <asp:TextBox ID="txtQuotationDate" CssClass ="form-control" runat="server"  EnableTheming="False" ReadOnly="True"></asp:TextBox>
                                 </div>
                             </div>
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                     <asp:DropDownList ID="ddlCustomer" CssClass ="form-control" runat="server" AutoPostBack="True" Enabled="False"
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                     <asp:DropDownList ID="ddlUnitName" CssClass ="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlUnitName_SelectedIndexChanged">
                                 ...
                                 <div class="col-sm-4">
                                    <asp:TextBox ID="txtUnitAddress" CssClass ="form-control" runat="server" EnableTheming="False"
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                     <asp:TextBox ID="txtContactPerson" CssClass ="form-control" runat="server" ReadOnly="True"> </asp:TextBox><asp:DropDownList ID="ddlContactPerson" CssClass ="form-control " runat="server" AutoPostBack="True"
                            ...
                            <div class="form-group">
                                 <label class="col-sm-2 control-label text-right">Contact Person</label>
                                 <div class="col-sm-4">
                                      <asp:TextBox ID="txtPhoneNo" CssClass ="form-control" runat="server" ReadOnly="True"> </asp:TextBox>
                                 ...
                                 <div class="col-sm-4">
                                    <asp:TextBox ID="txtMobile" CssClass ="form-control" runat="server" ReadOnly="True"> </asp:TextBox>
                                 </div>
                             </div>
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                      <asp:TextBox ID="txtExecutiveName" CssClass ="form-control" runat="server"></asp:TextBox>
                                 </div>
                                 <label class="col-sm-2 control-label text-right">Phone No</label>
                                 <div class="col-sm-4">
                                    <asp:TextBox ID="txtExePhoneNo" CssClass ="form-control" runat="server"></asp:TextBox>
                                 </div>
                             </div>
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                      <asp:TextBox ID="txtSalesOrderNo" CssClass ="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                                 </div>
                                 <label class="col-sm-2 control-label text-right">Purchase Order Date</label>
                                 <div class="col-sm-4">
                                      <asp:TextBox ID="txtSalesOrderDate" CssClass ="form-control" runat="server"  type="datepic"></asp:TextBox>
                                 </div>
                             </div>
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                      <asp:TextBox ID="txtCustPONo" CssClass ="form-control" runat="server"></asp:TextBox>
                                 </div>
                                 <label class="col-sm-2 control-label text-right">Customer PO Date</label>
                                 <div class="col-sm-4">
                                      <asp:TextBox ID="txtCustPODated" CssClass ="form-control" runat="server"  EnableTheming="False" type="datepic"></asp:TextBox>
                                 </div>
                             </div>
                    ...
                    <h6 class="panel-title">Architect Details</h6>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                     <asp:DropDownList ID="ddlArchitect" CssClass ="form-control" runat="server" OnSelectedIndexChanged="ddlArchitect_SelectedIndexChanged"
                                     AutoPostBack="True" ></asp:DropDownList>
                                     <asp:TextBox ID="txtArchitect" CssClass ="form-control" runat ="server" ></asp:TextBox>

                                 </div>
                                 <label class="col-sm-2 control-label text-right">Consolidated PO Amount</label>
                                 <div class="col-sm-4">
                                    <asp:TextBox ID="txtPOAmt1" CssClass ="form-control" runat="server" ></asp:TextBox>
                                 </div>
                             </div>
                            <div class="form-group">
                                 <label class="col-sm-2 control-label text-right">PO Amount</label>
                                 <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <asp:GridView ID="gvFPS" runat ="server" AutoGenerateColumns="False" Width="100%">
                                    <Columns >
                                    ...
                                    <asp:BoundField DataField="po_Amt" HeaderText="po Amt" Visible ="false" ></asp:BoundField>
                                    <asp:BoundField DataField="PO_Amt1" HeaderText="Consolidated PO Amt" Visible ="false" ></asp:BoundField>
                                    <asp:BoundField DataField="Percntage" HeaderText="Percentage" Visible ="false" ></asp:BoundField>
                                    <asp:BoundField DataField="TotalAmt" HeaderText="Total Amt" Visible ="false"></asp:BoundField>
