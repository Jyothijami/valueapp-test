...
public partial class Modules_SM_WorkOrderDetails : basePage
{
           ...
           // SM.WorkOrder objWorkOrder = new SM.WorkOrder();
            ...
            foreach (GridViewRow gvrow in gvOrderAcceptanceItems.Rows)
            {
                ...
                {                   
                        ...
                        //    else
                        //    {
                        //        MessageBox.Show(this, "Reqired quantity is unavaliable in Stock");
                        //    }
                        //}
            ...
            //        {
            //            CheckBox chkl;
            //            chkl = (CheckBox)gvrow1.FindControl("chk");
    ...
    //    CheckBox ch;
    //    ch = (CheckBox)sender;
    //    GridViewRow gvrow = (GridViewRow)ch.Parent.Parent;

    //    gvOrderAcceptanceItems.SelectedIndex = gvrow.RowIndex;
    //    CheckBox ChkBoxRows = (CheckBox)gvrow.FindControl("Chk");
    //    if (ChkBoxRows.Checked == true)
    //    {
    //        lblItemCode.Text = gvOrderAcceptanceItems.SelectedRow.Cells[1].Text;
    //        lblColor.Text = gvOrderAcceptanceItems.SelectedRow.Cells[15].Text;

    //        Masters.ItemMaster objMaster = new Masters.ItemMaster();
    //        if (objMaster.TtlStockAvail_select(lblItemCode.Text, lblColor.Text) > 0)
    //        {
    //            lblTtlQty.Text = objMaster.AvaliableQuantity;
    //            lblBlockQty.Text = objMaster.BlockQuantity;
    //            lblAvaliableQty.Text = objMaster.AvaliableQuantity;
    //        }

    //        if (objMaster.StockAvail_select(lblItemCode.Text, lblColor.Text) > 0)
    //        {
    //            lblAvaliableQty.Text = objMaster.AvaliableQuantity;
    ...
    protected void btnCheck_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gvrow in gvOrderAcceptanceItems.Rows)
        {
            ...
            if (ch.Checked == true)
            {
                ...
                if (objMaster.CustStockAvail_select(lblItemCode.Text, lblColor.Text, txtWONo.Text, lblCust_Id.Text) > 0)
                {                   
                    lblCustQty.Text = objMaster.CustQty;
                }
                else
