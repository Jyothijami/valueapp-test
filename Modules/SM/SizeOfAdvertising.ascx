<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SizeOfAdvertising.ascx.cs" Inherits="Modules_SM_SizeOfAdvertising" %>
 ...
 <table style="width: 783px" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="3">
                                        <asp:DropDownList ID="ddlSearchBy" runat="server" AutoPostBack="True" CssClass="textbox"
                                            ...
                                            <asp:ListItem Value="SA_ID">S.No</asp:ListItem>
                                            <asp:ListItem Value="SA_SIZE">Size</asp:ListItem>
                                            <asp:ListItem Value="SA_DESC">Description</asp:ListItem>
                                        </asp:DropDownList></td>
                                    <td rowspan="3">
                                        </td>
                                    <td rowspan="3">
        ...
        <tr>
            <td colspan="2" style="height: 19px; text-align: center">
                &nbsp;&nbsp;<asp:GridView ID="gvSize" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    DataSourceID="sdsSizeOfAdvertising" OnRowDataBound="gvSize_RowDataBound">
                    <Columns>
                        <asp:BoundField DataField="SA_SIZE" HeaderText="SizeOfAdvertisingIdHidden" />
                        <asp:BoundField DataField="SA_ID" HeaderText="S.NO">
                            <ItemStyle HorizontalAlign="Right" />
                            <HeaderStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Size Of Advertising">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("SA_SIZE") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnSizeOfAdvertising" runat="server" CausesValidation="False"
                                    OnClick="lbtnSizeOfAdvertising_Click" Text="<%# Bind('SA_SIZE') %>"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="SA_DESC" HeaderText="Description" NullDisplayText="-">
                            <ItemStyle HorizontalAlign="Left" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                    </Columns>
                ...
                <asp:SqlDataSource ID="sdsSizeOfAdvertising" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
                    SelectCommand="SP_SM_SIZE_OF_ADVERTISING_SELECT" SelectCommandType="StoredProcedure">
                    <SelectParameters>
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                &nbsp;<table id="tblSize" runat="server" border="0" cellpadding="0" cellspacing="0"
                ...
                General Details</td>
                    ...
                    <tr>
                        <td style="text-align: right">
                            <asp:Label ID="lblAdvertising" runat="server" Text="Size  of Advertising"></asp:Label></td>
                        <td style="text-align: left">
