<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" CodeFile="SalesQuotationDetails1.aspx.cs" Inherits="Modules_SM_SalesQuotationDetails1" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="tblQuotationDetails" runat="server"
                        ...
                        <asp:GridView ID="gvQuotationItems" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvQuotationItems_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Rate" HeaderStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtDetRate" runat="server"  Text='<%# Bind("Rate") %>' OnTextChanged="txtDetRate_TextChanged" Width ="100%"  AutoPostBack="true"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Room" HeaderStyle-Width="150px">
                                    <ItemTemplate>
                ...
                <tr style="background-color:#98b7e9"><td style="width:12%"></td>
                                <%--<td ></td>--%>
                                <td style="width:32%;color:black;font-weight:bold;text-align :right">
                                    Total Amount :
                                </td>
                                <td style="width:13%;color:red;font-weight:bold">
                                    <asp:Label ID="lblTtlAmt" runat="server">0</asp:Label>
                                </td>
                                <td style="color:red;font-weight:bold">
                                    <asp:Label ID="lblTtlGSTAmt" runat ="server"  >0</asp:Label>
                                </td>
                            </tr>
                <tr>
                    <td colspan="4" style="text-align: right">Discount
                        <asp:TextBox ID="txtItemDisc" Width ="50px" runat ="server" ></asp:TextBox>
                        <asp:Button ID="btnDisc" runat ="server" CssClass ="btn btn-success" Width ="60px" OnClick ="btnDisc_Click" EnableTheming ="false"  Text ="Apply" />
                    </td>
                    <%--<td >&nbsp;</td>--%>
                </tr>
                <tr>
                        ...
                        <table id="tblButtons" border="0" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                ...
                                <td style="height: 24px">
                                    ...
                                    <asp:Button ID="btnNotif" runat="server" OnClick="btnNotif_Click" Text="Send Mail to EDP for Approval" Width="100%" />
                                </td>
                                <td style="height: 24px">
                        ...
                        <table id="tblDiscountSelect" runat="server" visible="false" width="100%" align="center">
                            ...
                            <tr>
                                ...
                                <asp:RadioButton ID="rdbPert" runat="server" AutoPostBack="True" GroupName="a"
                                 ...
                                 <td class="auto-style4">
                                    <asp:RadioButton ID="rdbGSTInclusive" runat="server" AutoPostBack="True" GroupName="a"
                                        OnCheckedChanged="rdbGSTInclusive_CheckedChanged" Text="MRP + Spl Price + Unit Price (GST Inclusive)" Width="200px"></asp:RadioButton></td>
                                <td class="auto-style4">
                                    <asp:RadioButton ID="rdbWoprices" runat="server" AutoPostBack="True" GroupName="a"
                                        OnCheckedChanged="rdbWoprices_CheckedChanged" Text="with code + Without Prices" Width="200px"></asp:RadioButton></td>
                                 <td class="auto-style4">
                                    <asp:RadioButton ID="rdbwocodeprices" runat="server" AutoPostBack="True" GroupName="a"
                                        OnCheckedChanged="rdbwocodeprices_CheckedChanged" Text="Without Code + Without Prices" Width="200px"></asp:RadioButton></td>
     ...
     <asp:Button ID="btnExport2"   runat="server" Text="Export To Excel" OnClick="btnExport2_Click"/>
         <asp:Button ID="btnExportPdf"   runat="server" Text="Export To PDF" Visible ="false"  OnClick="btnExportPdf_Click"/>
