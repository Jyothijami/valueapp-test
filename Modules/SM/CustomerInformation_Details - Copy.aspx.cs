        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["CustId"] != null)
            {
                ...
                try
                {
                    ...
                    if ((objSMCustomer.CustomerMaster_Select(Request.QueryString["CustId"].ToString())) > 0)
                    {
                        ...
                        ddlreference.SelectedValue = objSMCustomer.ECCNo;
                        ...
                        {
                            ListItem  listbox = ListBox1.Items.FindByValue(dt1.Rows[j][0].ToString());
                            if (listbox != null)
                            {
            ...
            if (Request.QueryString["CustId"] != null)
            {
                ...
                if ((objSMCustomer.CustomerMaster_Select(CustId)) > 0)
                {
                    ...
                    txtWebsite.Text = objSMCustomer.Website;
                    txtPANNo.Text = objSMCustomer.PANNo;
                    ddlreference.Text = objSMCustomer.ECCNo;
                    ddlbudjet.SelectedValue = objSMCustomer.CSTNo;
                    ddlfollowup.SelectedValue = objSMCustomer.LocalSTNo;
                    txtSpecialInstructions.Text = objSMCustomer.SplInsrs;
                    ddlDesignationNo.SelectedValue = objSMCustomer.DesgId;
    ...
    private void CustomerMasterSave()
    {
        ...
        else
        {
            try
            {
                ...
                objMaster.ECCNo = ddlreference.SelectedItem.Value;
