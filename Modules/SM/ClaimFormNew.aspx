<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/PurchaseMP1.master" AutoEventWireup="true" CodeFile="ClaimFormNew.aspx.cs" Inherits="Modules_SM_ClaimFormNew" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <%--<script>
        $(function () {
            $("[name$='txtDate'],[name$='txtOrderDate']").datepicker();
        });
    </script>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" class="pagehead">
        <tr>
            <td style="text-align:left">Claim Form</td>
        </tr>
    </table>
            ...
            <td colspan="4" style="text-align: center; height: 471px;">
                <table border="0" cellpadding="0" cellspacing="0" id="tblClaimForm" runat="server"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtOrderDate" type="date" runat="server">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="height: 24px; text-align: left">&nbsp;<asp:TextBox ID="txtSpecification" runat="server" TextMode="MultiLine" Width="508px"
                    ...
                    <tr>
                        <td colspan="4" style="height: 24px; text-align: right"></td>
                    </tr>
                    <tr>
                        <td style="height: 24px; text-align: right">&nbsp;<asp:Label ID="lblTotal" runat="server" Text="Total ExWorks"></asp:Label></td>
                        <td style="height: 24px; text-align: left;">
                    ...
                    <tr>
                        <td colspan="4" style="text-align: left" class="profilehead">Transfer Details</td>
                    </tr>
                    <tr>
                        <td style="text-align: right;"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: left">&nbsp;<asp:TextBox ID="txtConsignee" runat="server" TextMode="MultiLine" Width="508px"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left" colspan="3">&nbsp;<asp:TextBox ID="txtInstructions" runat="server" TextMode="MultiLine" Width="508px"
                    ...
                    <tr>
                        <td colspan="4" style="text-align: right; height: 20px;">
                            <table id="tblInsuranceCompany" width="100%">
                                <tr>
                                    <td class="profilehead" colspan="4">Insurance details</td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <tr>
                        <td colspan="4" style="height: 20px; text-align: right"></td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align: left; height: 20px;" class="profilehead">Reference Details</td>
                    </tr>
                    <tr>
                        <td style="height: 21px; text-align: right;"></td>
                        <td style="height: 21px; text-align: left;"></td>
