<%@ Page Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" Async="true"
    CodeFile="SalesOrder - Copy.aspx.cs" Inherits="Modules_SM_SalesOrder" Title="|| Value App : S&M : Sales Order ||" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="height: 25px">
                                        <asp:DropDownList ID="ddlSearchBy" runat="server" AutoPostBack="True" CssClass="textbox"
                                            ...
                                            <asp:ListItem Value ="Balanceqty" >Status</asp:ListItem>
                                            <asp:ListItem Value ="Executive">Executive Name</asp:ListItem>
        ...
        <tr>
            <td colspan="4">
                <asp:GridView ID="gvSalesOrderDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames ="SO_ID" OnRowCommand ="gvSalesOrderDetails_RowCommand"
                    ...
                    <Columns>
                        ...
                        <ItemTemplate>
                            <span class="text-center">
                                <asp:LinkButton ID="lbtnDocuments" runat="server" ForeColor ="Green" Font-Underline ="true"   PostBackUrl='<%# "~/Modules/SM/SalesOrderDocs.aspx?Cid=" + Eval("SO_Id") %>'>docs</asp:LinkButton>
                            </span>
                        </ItemTemplate>
                        ...
                        <asp:TemplateField >
                            <ItemTemplate >
                                <asp:Button ID="btnAcceptence" runat="server" Text="Manual Close" CommandName ="Manual Close" CommandArgument='<%# Eval("SO_ID").ToString() %>' Width ="100% "  />
                             </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField  >
                            <ItemTemplate >
                                <asp:Button ID="btnFPS" runat="server" Text="FPS" CommandName ="FPS" CommandArgument='<%# Eval("SO_ID").ToString() %>' Width ="100% " />
                             </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
                ...
                <table border="0" cellpadding="0" cellspacing="0" id="tblSalesOrderDetails" runat="server"
                    ...
                    <tr>
                        ...
                        <td style="height: 22px; text-align: left">
                            <asp:DropDownList ID="ddlCustomer" runat="server" AutoPostBack="True" Enabled="False"
                                ...
                                Text="*"> </asp:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="ddlCustomer"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            ...
                            <asp:Label ID="Label60" runat="server" EnableTheming="False" ForeColor="Red"
                                Text="*"> </asp:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtSalesOrderDate"
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center">
                            ...
                            <asp:Button ID="btnUpdatePO" runat="server" CausesValidation="False" OnClick="btnUpdatePO_Click"
                                Text="Update" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtTINNo" runat="server"> </asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; height: 23px;">
                            <asp:TextBox ID="txtDelivery" runat="server"> </asp:TextBox><asp:Label ID="Label40" runat="server" EnableTheming="False" ForeColor="Red"
                                Text="*"> </asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtPaymentTerms" runat="server"> </asp:TextBox><asp:Label ID="Label42" runat="server" EnableTheming="False" ForeColor="Red"
                                Text="*"> </asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtVAT" runat="server" onkeypress="CheckNumeric(event);"> </asp:TextBox>
                            <asp:TextBox ID="txtInspection" runat="server" onkeypress="CheckNumeric(event);" Visible="False"> </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtGuarantee" runat="server"> </asp:TextBox><asp:Label ID="Label45" runat="server" EnableTheming="False" ForeColor="Red"
                                Text="*"> </asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtInsurance" runat="server"> </asp:TextBox><asp:Label ID="Label47" runat="server" EnableTheming="False" ForeColor="Red"
                                Text="*"> </asp:Label>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtTransCharges" runat="server"> </asp:TextBox><asp:Label ID="Label48" runat="server" EnableTheming="False" ForeColor="Red"
                                Text="*"> </asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtAdvanceAmt" runat="server"> </asp:TextBox><cc1:FilteredTextBoxExtender ID="ftxteAdvanceAmt" runat="server" TargetControlID="txtAdvanceAmt"
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtDeliveryDateForAll" runat="server" type="datepic" Visible="False"> </asp:TextBox>
                    ...
                    <tr>
                        <td style="text-align: right">
                            <asp:Label ID="lblResponsiblePerson" runat="server" Text="Contact Name" Width="96px"> </asp:Label></td>
                        <td style="text-align: left">
                            <asp:TextBox ID="txtContactName1" runat="server" TabIndex="1"> </asp:TextBox><asp:Label ID="Label62" runat="server" EnableTheming="False" ForeColor="Red"
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtContactName2" runat="server" TabIndex="5"> </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="height: 19px; text-align: left">
                            <asp:TextBox ID="txtPhone1" runat="server" TabIndex="3"> </asp:TextBox><asp:Label ID="Label64" runat="server" EnableTheming="False" ForeColor="Red"
                        ...
                        <td style="height: 19px; text-align: left">
                            <asp:TextBox ID="txtPhone2" runat="server" TabIndex="7"> </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="height: 19px; text-align: left">
                            <asp:TextBox ID="txtEmail1" runat="server" TabIndex="4"> </asp:TextBox></td>
                        <td style="height: 19px; text-align: right">
                            <asp:Label ID="Label31" runat="server" Text="E-Mail" Width="96px"></asp:Label></td>
                        <td style="height: 19px; text-align: left">
                            <asp:TextBox ID="txtEmail2" runat="server" TabIndex="8"> </asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            <asp:Label ID="lblApprovedBy" runat="server" Text="Obsoleted By"></asp:Label></td>
                        <td style="text-align: left">
                            ...
                            <table id="tblButtons" align="center">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="btnAcceptence" runat="server" Text="Manual Close" OnClick="btnAcceptence_Click" Width="100px" />
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">FPS Details</h4>
                </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <asp:TextBox ID="txtFPSPOno" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                                <label class="col-sm-2 control-label text-right">PO Date :</label>
                                                <div class="col-sm-4">
                                                    <asp:TextBox ID="txtFPSPODt" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
