<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" CodeFile="DailyReportView.aspx.cs" Inherits="Modules_SM_DailyReportView" %>
    ...
    <div class ="row">
        ...
        <div class="form-group">
            ...
            <label class="col-sm-2 control-label text-right">Employee Name :</label>
                ...
                <div class="form-group">
            <label class="col-sm-2 control-label text-right">Plan of Action :</label>
                            <div class="col-sm-4">
...
<div class="row">
   <%-- <strong>DailyReport Count :</strong><asp:LinkButton ID="lnkDR" runat ="server"><asp:Label ID="lblDRCount" runat ="server" ></asp:Label></asp:LinkButton> &nbsp;&nbsp;&nbsp;&nbsp;
    <strong>Follow Up (With Clients) Count :</strong><asp:Label ID="lblFUCount" runat ="server" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
    <strong>Comments (Inter Office Notes) Count :</strong><asp:Label ID="Label4" runat ="server" ></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;--%>
    <asp:RadioButtonList ID="rdblist" runat ="server" RepeatDirection ="Horizontal" ></asp:RadioButtonList>
</div>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
            ...
            <asp:GridView ID="gvDrs" Width="100%" runat="server" CssClass="display" AllowPaging="True" OnPageIndexChanging ="gvDrs_PageIndexChanging" SelectedRowStyle-BackColor="#c0c0c0" EmptyDataText="No Records To Display" AutoGenerateColumns="False" OnRowDataBound="gvDrs_RowDataBound" Font-Names="Calibri" Font-Size="Small">
        <Columns>
...
<HeaderStyle CssClass="text-center"></HeaderStyle>
                        ...
                        <div class="col-md-6">
                            <blockquote>
                               ...
                               <strong> Reference :</strong>  <%#Eval("Reference")%>
                                <br />
                                <strong>Executive / Architect :</strong><%#Eval("Architect")%><br /><strong>Type :</strong><%#Eval("DR_Type")%><br /><span class="text-danger"><strong>AttendedBy :</strong> <%#Eval("Attended By")%></span><br />

                                <span class="text-danger"><strong>Backup : </strong><%#Eval("Backup Name")%></span>
                                <br /><span class="text-danger"><strong><%#Eval("DR_FollowUp")%> By :</strong> <%#Eval("Executive Name")%></span>
                            </blockquote>
                        </div>
            ...
            <asp:TemplateField HeaderText="Comments/Follow Up's">
                <ItemTemplate>
                    ...
                    <div class="row">
                        ...
                        <a runat="server" class="btn btn-icon btn-success" href='<%# "~/Modules/SM/RemarksView.aspx?Cid=" + Eval("DAILYREPORTID") %>' onclick="OpenPopupCenter(this.href, 'newwindow', 800, 500);return false; ">
                           <%-- <i class="icsw16-speech-bubbles"></i><span class="badge badge-important">
                            ...
                            <span style="color:white"><strong> Comments / <br /> Followup's</strong> </span>
            ...
            <asp:TemplateField HeaderText="Edit">
                <ItemTemplate>
                    <div class="row">
                        <div class="col-md-12 ">
                            <span class="text-center">
                        <asp:HyperLink  runat="server" class="btn btn-icon btn-primary " ID="btnedit1" href='<%# "DailyReportEdit.aspx?Cid=" + Eval("DAILYREPORTID") %>' onclick="OpenPopupCenter(this.href, 'newwindow', 800, 500);return false; ">
                           <%-- <i class="icsw16-speech-bubbles"></i><span class="badge badge-important">
                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("Cou") %>'></asp:Label></strong></span>--%>
            ...
            <asp:BoundField DataField ="createdOn" HeaderText ="Created On" DataFormatString ="{0:f}"  />
        </Columns>
        <HeaderStyle HorizontalAlign="Center" />
