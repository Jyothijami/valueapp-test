<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/SalesMP1.master" AutoEventWireup="true" CodeFile="SalesOrder_Search - Copy (2).aspx.cs" Inherits="Modules_Reports_SalesOrder_Search" %>
            ...
            <Columns>
              ...
              <%--  <asp:BoundField DataField ="Customer Name" HeaderText ="Customer" />--%>
                ...
                <asp:TemplateField HeaderText="Customer Details" HeaderStyle-CssClass="text-center">
                    <ItemTemplate>
                        <div class="row">
                            Customer Name : <%#Eval("Customer Name")%>
                            <br />
                            PO No : <%#Eval("So No")%>
                            <br />

                            PO Date : <%#Eval("SO Date")%>
                            <br />
                            Executive Name : <%#Eval("Executive Name")%>
                        </div>
                    </ItemTemplate>
                ...
                <asp:BoundField DataField ="Blocked Qty" HeaderText ="Bloc Qty" />
