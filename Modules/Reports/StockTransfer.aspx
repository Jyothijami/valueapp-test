<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StockTransfer.aspx.cs" Inherits="Modules_Reports_DailyReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
     <table border="0" cellpadding="0" cellspacing="0" class="pagehead">
        <tr>
            <td style="text-align: left">DC & Stock Out based on locations </td>
        </tr>
    </table>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblDailyReport" runat="server">
                    <tr>
                        <td class="profilehead" colspan="3" style="text-align: left; height: 20px;">Report</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: right">
                            <asp:Label ID="Label45" runat="server" Text="Company"></asp:Label></td>
                        <td style="text-align: left">
                    ...
                    <tr>
                        <td style="text-align: right">
                            <asp:Label ID="Label46" runat="server" Visible ="false"  Text="Employee Name" ></asp:Label></td>
                        <td style="text-align: left">
                            <asp:DropDownList ID="ddlEmpDaily" Visible ="false"  runat="server" Width="147px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
