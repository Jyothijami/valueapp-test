<%@ Control Language="C#" AutoEventWireup="true" CodeFile="graph_FeedbackCountMonthly.ascx.cs" Inherits="Modules_widgets_graph_FeedbackCountMonthly" %>
    ...
    $(function () {
        ...
        $(document).ready(function () {
            ...
            SalesQMchart = new Highcharts.Chart({
                ...
                title: {
                    text: 'Feedback Survey Monthwise'
                },
                xAxis: {
                    type: 'category'
                },
