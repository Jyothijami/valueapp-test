<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SalesQuot_AnnualRpt.ascx.cs" Inherits="Modules_widgets_SalesQuot_AnnualRpt" %>
		    ...
		    $(function () {
		        ...
		        $(document).ready(function () {
		            SQchart = new Highcharts.Chart({
		                ...
		                title: {
		                    text: 'Sales Quotation Annual Rpt'
		                },
		                subtitle: {
