<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Vouchers/Voucher.master" AutoEventWireup="true" CodeFile="ContraVoucher.aspx.cs" Inherits="Modules_ContraVoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
      ...
      <tr>
        ...
        <tr>
         ...
         <tr>
            <td style="text-align:center"><b>Contra Voucher</b></td>
        </tr>
    </table>
    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp; Cash :
            ...
            <td>
             ...
             <td colspan="2" style="text-align:center">
                <asp:TextBox ID="txtDebit" TextMode="MultiLine" runat="server" Width="150px" Height="160px"></asp:TextBox>
                <asp:TextBox ID="txtCredit" TextMode="MultiLine" runat="server" Width="150px" Height="160px"></asp:TextBox>
            </td>
        </tr>
        <tr>
       <%--     <td>
