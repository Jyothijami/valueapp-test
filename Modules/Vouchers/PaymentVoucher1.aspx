<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Vouchers/Voucher.master" AutoEventWireup="true" CodeFile="PaymentVoucher1.aspx.cs" Inherits="Modules_Profiles_PaymentVocher1" %>
     ...
     <table align="center">
      ...
      <tr>
        ...
        <tr>
         ...
         <tr>
            <td style="text-align:center"><b>Payment Voucher</b></td>
        </tr>
    </table>
    <br />
