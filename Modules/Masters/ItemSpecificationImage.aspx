<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemSpecificationImage.aspx.cs" Inherits="Modules_Masters_ItemSpecificationImage" %>
...
<body>
    ...
    <div style="text-align: center">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 725px">
            <tr>
                <td class="searchhead" colspan="4" style="height: 38px; text-align: right">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="width: 272px; text-align: left">
                                Item&nbsp; Specification Image</td>
            ...
            <tr>
                <td colspan="4" style="height: 21px; text-align: center">
                    &nbsp;<asp:GridView ID="gvProductMasterDetails" runat="server" AllowPaging="True"
                        AllowSorting="True" AutoGenerateColumns="False" DataSourceID="sdsProductMaster"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Item Image">
                                <ItemTemplate>
                                    <asp:Image ID="Image" runat="server" EnableTheming="False" Height="46px" ImageUrl='~/Images/noimage400x300.gif'
                                        Width="67px" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
