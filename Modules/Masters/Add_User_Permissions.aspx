<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Add_User_Permissions.aspx.cs" Inherits="Modules_Masters_Add_User_Permissions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
    ...
    <table style="width: 100%">
        <tr>
        <td style="text-align:left">User Name :
        <asp:Label ID="lblUser_Id" runat="server" Font-Bold="true" Visible="false"></asp:Label>
        <asp:Label ID="lblUserId" runat="server" Font-Bold="true" Visible="true"></asp:Label>
            ...
            <td style="text-align: center; font-size: medium;">
                ...
                &nbsp;||&nbsp;
                            <asp:LinkButton ID="lnk3" runat="server" OnClick="lnk3_Click" Font-Underline="True">Purchases</asp:LinkButton>
                &nbsp;||&nbsp;
                            ...
                            <asp:GridView ID="gvSMPriv1" runat="server" AutoGenerateColumns="False" DataKeyNames="PRIVILEGE_ID" DataSourceID="masterprivsds2">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Full">
                                     ...
                                     <asp:TemplateField HeaderText="AdminGrid Rights">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="cbxAdminGridRights" runat="server" Checked='<%# getPermission("8", Eval("PRIVILEGE_ID").ToString()) %>'  />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
