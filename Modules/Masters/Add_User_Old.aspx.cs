...
using System.Configuration;
public partial class Modules_Admin_Add_User_Old : basePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            lblDate.Text = "2020-12-31 00:00:00.000";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (btnSave.Text == "Save")
        {
            ...
            userid = usre.getUserID(uusername);
        ...
        else
        {
            ...
            //username = gvAddUserDetails.SelectedRow.Cells[2].Text.ToString();
            //username = gvAddUserDetails.DataKeys[2].Value.ToString();
        }

        userid = usre.getUserID(username);
        ...
        MessageBox.Show(this, "Records Saved Successfully");
        BindGrid_All();
    }
    ...
    protected void setPermissions(string userid)
    {

        uPriv.SavePermission("1", "87", userid, false);
        uPriv.SavePermission("2", "87", userid, false);
        uPriv.SavePermission("3", "87", userid, false);
        uPriv.SavePermission("4", "87", userid, false);
        uPriv.SavePermission("5", "87", userid, false);
        uPriv.SavePermission("6", "87", userid, false);
        uPriv.SavePermission("7", "87", userid, true);
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        if (gvAddUserDetails.SelectedIndex > -1)
        {
            ...
            {
                ddluserSubType1.SelectedValue = "61";
            }
    ...
    protected void btnPermissions_Click(object sender, EventArgs e)
    {
        if (gvAddUserDetails.SelectedIndex > -1)
        {
            Response.Redirect("Add_User_Permissions.aspx?UserId=" + txtUserId.Text);
    ...
    {
        SqlCommand cmd = new SqlCommand("USP_ADDUSER_SEARCH_SELECT", con);
        cmd.CommandType = CommandType.StoredProcedure;
        

        if (txtUser1.Text != "")
        {
            cmd.Parameters.AddWithValue("@User_Name", txtUser1.Text);
        }
        if (txtDesig1.Text != "")
        {
        ...
        if (txtComp1.Text != "")
        {
            cmd.Parameters.AddWithValue("@Company_Name", txtComp1.Text);
        }
        if (txtDept1.Text != "")
        {
            cmd.Parameters.AddWithValue("@Department", txtDept1.Text);
        }
        ...
        da.Fill(dt);
        gvAddUserDetails.DataSource = dt;
        gvAddUserDetails.DataBind();
    }


    protected void gvAddUserDetails_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        gvAddUserDetails.PageIndex = e.NewPageIndex;
        BindGrid_All();
    }
    string reference;
    protected void lnkUserValidity_Click(object sender, EventArgs e)
    {
        reference = "Add User Validity Update";
        pnlUser.Visible = true;
        pnlEmp.Visible = false;
    }
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        gvUser.PageSize = Convert.ToInt32(DropDownList1.SelectedValue);
        gvUser.DataBind();
    }
    //protected void btnPageNoSearch_Click1(object sender, EventArgs e)
    //{
    //    gvUser.PageIndex = Convert.ToInt32(txtPageNo.Text) - 1;
    //}
    protected void btnExpDt_Click(object sender, EventArgs e)
    {
        try
        {
            foreach (GridViewRow gvrow in gvUser.Rows)
            {
                ...
                if (ch.Checked == true)
                {
                    ...
                    obj.UserId = gvrow.Cells[1].Text;
                    obj.ExpiryDate = Yantra.Classes.General.toMMDDYYYY(txtExDate.Text);
                    obj.Update_UserExpDate(gvrow.Cells[1].Text);
                    gvUser.DataBind();
                }
            }
        }
    ...
    protected void lnkEmpValidity_Click(object sender, EventArgs e)
    {
        reference = "Emp Validity Date Update";
        pnlUser.Visible = false;
        pnlEmp.Visible = true;
    }
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        gvEmp.PageSize = Convert.ToInt32(DropDownList2.SelectedValue);
        gvEmp.DataBind();
    }
    protected void btnEmpExpdt_Click(object sender, EventArgs e)
    {
        try
        {
            foreach (GridViewRow gvrow in gvEmp.Rows)
            {
                ...
                if (ch.Checked == true)
                {
                    HR.EmployeeMaster obj = new HR.EmployeeMaster();
                    obj.UserId = gvrow.Cells[1].Text;
                    obj.ExpiryDate = Yantra.Classes.General.toMMDDYYYY(TextBox3.Text);
                    obj.Update_EmpExpDate(gvrow.Cells[1].Text);
                    gvEmp.DataBind();
                }
            }
        }
