<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ForwarderDetails1.ascx.cs" Inherits="Modules_Masters_ForwarderDetails" %>
                            ...
                            <tr>
                                ...
                                <td rowspan="3">
                                    <asp:DropDownList ID="ddlSearchBy" runat="server" AutoPostBack="True" CssClass="textbox"
                                        ...
                                        <asp:ListItem Value="Forwarder_id">ID</asp:ListItem>
                                        <asp:ListItem Value="Forwarder_Name">Name</asp:ListItem>
        ...
        <td colspan="2" style="text-align: center">
            <asp:GridView ID="gvForwarderDetails" SelectedRowStyle-BackColor="#c0c0c0" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Forwarder_id" HeaderText="S.No">
                        <ItemStyle HorizontalAlign="Right" />
                        <HeaderStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="Forwarder Name">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Currency_name") %>'></asp:TextBox>
                        </EditItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnForwarderName" ForeColor="#0066ff" runat="server" CausesValidation="False" OnClick="lbtnCurrencyName_Click"
                                Text='<%# Bind("Forwarder_Name") %>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:SqlDataSource ID="sdsForwarderDetails" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
                SelectCommand="SP_MASTER_FORWARDDETAILS_SEARCH_SELECT" SelectCommandType="StoredProcedure">
                <SelectParameters>
        ...
        <td>
            <table id="tblCurrencyDetails" runat="server" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:TextBox ID="txtForwarderName" runat="server"  Width="133px"></asp:TextBox><asp:Label
