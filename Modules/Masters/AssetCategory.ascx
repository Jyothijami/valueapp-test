<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AssetCategory.ascx.cs" Inherits="Modules_Masters_AssetCategory" %>
...
<ItemTemplate>
<asp:LinkButton id="lbtnCompanyName" ForeColor="#0066ff" onclick="lbtnCompanyName_Click" runat="server" Text="<%# Bind('ITEM_CATEGORY_NAME') %>" CausesValidation="False"></asp:LinkButton> 
</ItemTemplate>
</asp:TemplateField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                ...
                </asp:GridView><asp:SqlDataSource id="sdsCategoryDetails" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_MASTER_ASSET_CATEGORY_SEARCH_SELECT" SelectCommandType="StoredProcedure"><selectparameters>
