...
public partial class Modules_Masters_ForwarderDetails : System.Web.UI.UserControl
{
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        {
            tblCurrencyDetails.Visible = true;
            txttermtitle.Text = gvForwarderDetails.SelectedRow.Cells[1].Text;
            FreeTextBox1.Text = gvForwarderDetails.SelectedRow.Cells[2].Text;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        if (gvForwarderDetails.SelectedIndex > -1)
        {
            try
            {
                ...
                objMaster.Forid = gvForwarderDetails.SelectedRow.Cells[0].Text;
                MessageBox.Show(this, objMaster.Terms_Delete());
            }
            catch (Exception ex)
            {
    ...
    private void ForwardDetailsUpdate()
    {
        ...
        {
            Masters.ForwardedDetails objMaster = new Masters.ForwardedDetails();
            objMaster.Forname = txttermtitle.Text;
            objMaster.Forphone = FreeTextBox1.Text;
            //objMaster.Foraddress = txtAddress.Text;
            //objMaster.ForEmail = txtEmail.Text;
            //objMaster.Forphone = txtPhone.Text;
            objMaster.Forid = gvForwarderDetails.SelectedRow.Cells[0].Text;
            MessageBox.Show(this, objMaster.Terms_Update ());
        }
        catch (Exception ex)
        {
            MessageBox.Show(this, ex.Message);
    ...
    private void ForwardDetailsSave()
    {
        try
        {
            ...
            MessageBox.Show(this, objMaster.Terms_Save());
        }
