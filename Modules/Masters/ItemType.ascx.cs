...
public partial class Modules_Masters_ItemType : System.Web.UI.UserControl
{
    ...
    private void CategoryType()
    {
        try
        {
            Masters.ItemCategory.ItemCategory_Select(ddlCategoryName);
        }
        catch (Exception ex)
        {
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
            ...
            string pagenavigationstr = "../Reports/MastersReportViewer.aspx?type=ItemDetils";
