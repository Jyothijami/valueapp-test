...
public partial class Modules_Masters_ItemSpecificationImage : System.Web.UI.Page
{
    ...
    private void SaveImage()
    {
        ...
        if (contenttype != String.Empty)
        {
            ...
            String strQuery = "update YANTRA_ITEM_MAST set SPECIFICATION_IMAGE=@image WHERE ITEM_CODE=" + Convert.ToInt16(gvProductMasterDetails.SelectedRow.Cells[0].Text) + "";
    ...
    protected void gvProductMasterDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (count > 0)
                (e.Row.FindControl("Image") as Image).ImageUrl = "~/Modules/Masters/itemimagespecification.ashx?id=" + Convert.ToInt16(e.Row.Cells[0].Text) + "";
