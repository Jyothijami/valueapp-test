<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AssetType.ascx.cs" Inherits="Modules_Masters_AssetType" %>
    ...
    <tr>
        <td class="searchhead" colspan="2" style="text-align: left;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="text-align: left;">Asset Sub Category Details</td>
                    <td></td>
                    <td style="text-align: right;">
        ...
        <td colspan="2" style="text-align: center">
            <asp:GridView ID="gvItemTypeDetails" SelectedRowStyle-BackColor="#c0c0c0" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Asset Sub Category Name" meta:resourcekey="TemplateFieldResource1">
                        <EditItemTemplate>
                    ...
                    <asp:BoundField DataField="ITEM_CATEGORY_NAME" HeaderText="Asset Category Name">
                        <ItemStyle HorizontalAlign="Left" />
            ...
            <asp:SqlDataSource ID="sdsItemTypeDetails" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
                SelectCommand="SP_MASTER_AssetTYPE_SEARCH_SELECT" SelectCommandType="StoredProcedure">
                <SelectParameters>
                            ...
                            <tr>
                                <td style="height: 21px; text-align: right">
                                    <asp:Label ID="lblCategoryName" runat="server" meta:resourcekey="lblItemTypeNameResource1"
                                        Text="Asset Category Name" Width="153px"></asp:Label></td>
                                <td style="height: 21px; text-align: left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlCategoryName"
                                        ErrorMessage="Please Select Asset Category Name" meta:resourcekey="RequiredFieldValidator1Resource1" InitialValue="0">*</asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
                                <td style="text-align: right; height: 24px;">&nbsp; &nbsp; &nbsp;&nbsp;
                <asp:Label ID="lblItemTypeName" runat="server" Text="Asset Sub Category Name" Width="153px" meta:resourcekey="lblItemTypeNameResource1"></asp:Label></td>
                                <td style="text-align: left; height: 24px;">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtItemTypeName"
                                        ErrorMessage="Please Enter Asset Sub Category Name" meta:resourcekey="RequiredFieldValidator1Resource1">*</asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
