<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/AdminMP1.master" AutoEventWireup="true" CodeFile="Item_Purchase_Price_History.aspx.cs" Inherits="Modules_Masters_Item_Purchase_Price_History" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
    <div>
        <table class="pagehead">
            <tr>
                <td style="text-align: left">Item Purchase Price History
                </td>
            </tr>
        </table>
    </div>
        ...
        <table class="stacktable">
            <tr>
                <td colspan="5" style="text-align: left" class="profilehead">Update Item Purchase Price :</td>
            </tr>
            <tr>
                <td colspan="5">&nbsp;</td>
            </tr>
    ...
    <div>
        <table style="width:100%">
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvItemPriceHistory" runat="server" ShowFooter="true" Width="100%" AutoGenerateColumns="False" AllowPaging="true" AllowSorting="false" OnPageIndexChanging="gvItemPriceHistory_PageIndexChanging" OnRowDataBound="gvItemPriceHistory_RowDataBound"   >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Item Name" HeaderText="Series Name" SortExpression="Item Name" />
                    ...
                    <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="USP_ItemPurchasePriceHistory" SelectCommandType="StoredProcedure"></asp:SqlDataSource>--%>
