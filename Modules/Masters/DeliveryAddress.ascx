<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeliveryAddress.ascx.cs" Inherits="Modules_Masters_DeliveryAddress" %>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" style="height: 25px">
                                    <asp:DropDownList ID="ddlSearchBy" runat="server" AutoPostBack="True" CssClass="textbox"
                                        ...
                                        <asp:ListItem Value="DeliveryAddress_Id">Id</asp:ListItem>
                                        <asp:ListItem Value="Delivery_Name">Company</asp:ListItem>
                                        <asp:ListItem Value="Delivery_Address">Address</asp:ListItem>
                                    </asp:DropDownList></td>
    ...
    <tr>
        <td colspan="2" style="text-align: center">
            <asp:GridView ID="gvDespatchDetails" SelectedRowStyle-BackColor="#c0c0c0" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                Width="100%">
                <Columns>
                    <asp:BoundField DataField="Delivery_Name" HeaderText="NameHidden" />
                    <asp:BoundField DataField="DeliveryAddress_Id" HeaderText="Sl.No">
                    ...
                    <asp:TemplateField HeaderText="Company">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnDespatchName" ForeColor="#0066ff" runat="server" CausesValidation="False" OnClick="lbtnDespatchName_Click"
                                Text='<%# Bind("Delivery_Name") %>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="Delivery_Address" HeaderText="Address" NullDisplayText="-">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                </Columns>
                <EmptyDataTemplate>
            ...
            <asp:SqlDataSource ID="sdsInsuranceMaster" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>"
                SelectCommand="SP_MASTER_DeliveryAddress_SEARCH_SELECT" SelectCommandType="StoredProcedure">
                <SelectParameters>
                        ...
                        <table id="Table2" runat="server" border="0" cellpadding="0" cellspacing="0" visible="true"
                            ...
                            <tr>
                                <td style="height: 24px; text-align: right">
                                    &nbsp; &nbsp; &nbsp;&nbsp;
                                    <asp:Label ID="lblDespatchName" runat="server" Text="Delivery Company" Width="146px"></asp:Label></td>
