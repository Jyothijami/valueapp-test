<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/WarehouseMP1.master" AutoEventWireup="true" CodeFile="Stock_Report2.aspx.cs" Inherits="Modules_Warehouse_Stock_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
     <%-- <asp:UpdatePanel runat="server">
        <ContentTemplate>--%>
         <asp:Label ID ="lblIP" runat ="server" Text ="lbl" ></asp:Label>
            ...
            <div style="width: 100%">
                <table style="width: 100%" class="pagehead">
                    <tr>
                        ...
                        <td>
                    <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/dev_Pages/PhyStockVerify.aspx">Physical Stock Verification Page</asp:HyperLink>
                   <h4>||</h4> <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Modules/Warehouse/oldStock_qrcode.aspx">QR Code Generation</asp:HyperLink>
