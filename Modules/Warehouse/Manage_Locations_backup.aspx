<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/WarehouseMP1.master" AutoEventWireup="true" CodeFile="Manage_Locations_backup.aspx.cs" Inherits="Modules_Warehouse_Manage_Locations_backup" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%=chkCategoryList.ClientID%> input').click(function () {
                ...
                //reset all controls in Category edit
                $('#<%=lblCatTitle.ClientID%>').text("Add New Category");
                $('#<%=txtCategory.ClientID%>').val("");
                $('#<%=btnAddCategory.ClientID%>').val("Add");
                $('#<%=btnEditCategory.ClientID%>, #<%=btnDeleteCategory.ClientID%>').prop("disabled", (CheckedCount() * 1 == 0));
            ...
            $('#<%=btnAddCategory.ClientID%>').click(function () {
                if ($('#<%=txtCategory.ClientID%>').val().trim() == "") {
                    ...
                    $('#<%=txtCategory.ClientID%>').focus(); return false;
                }
            });
            $('#<%=btnEditCategory.ClientID%>, #<%=btnDeleteCategory.ClientID%>').click(function () {
                if (CheckedCount() * 1 == 0) {
                    alert("Select one item to do this operation");
                    return false;
                }
            });
            function CheckedCount() {
                return $('#<%=chkCategoryList.ClientID%> input:checked').length;
            }
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="editDiv" style="display: block;">
                        ...
                        <asp:DropDownList runat="server" Style="float: right;" ID="ddlLocations" AutoPostBack="true" OnSelectedIndexChanged="ddlLocations_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </td>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <!---->
                    <asp:TreeView ID="tvLocations" runat="server" onclcik="return false;" ExpandDepth="0" Visible="false">
                ...
                <td style="vertical-align: top; padding: 40px 2px 2px 40px;">
                    ...
                    <table>
                        <tr>
                            <td class="CategoryCss">
                                <asp:CheckBoxList ID="chkCategoryList" runat="server" RepeatLayout="UnorderedList"></asp:CheckBoxList>
                                <br />
                                <asp:Button Text="Edit" ID="btnEditCategory" runat="server" OnClick="btnEditCategory_Click" />
                                <asp:Button Text="Delete" ID="btnDeleteCategory" runat="server" OnClick="btnDeleteCategory_Click" />
                            </td>
                            <td style="vertical-align: top; padding-left: 10px;">
                                <table>
                                    <tr>
                                        <td colspan="2">
                                            <asp:Label Text="Add New Category" ID="lblCatTitle" runat="server" /></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtCategory" /></td>
                                        <td>
                                            <asp:Button Text="Add" runat="server" ID="btnAddCategory" OnClick="btnAddCategory_Click" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
