<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/InventoryMP1.master" AutoEventWireup="true" CodeFile="Warehouse_Report_WithImages - Copy.aspx.cs" Inherits="Modules_Warehouse_Warehouse_Report_WithImages" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    margin: 15px;
          ...
          #slider-range .ui-slider-range { background: #729fcf; }
  #slider-range .ui-slider-handle { border-color: #729fcf; }
    </style>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="text-align: right" colspan ="2">
                            <p>
                                <%--<asp:Label ID="lblamt" runat ="server" Text ="Price Range" ></asp:Label>
                                <asp:TextBox ID="amount" runat ="server" ReadOnly ="true" ForeColor ="#f6931f" style  ="font-weight:bold;" ></asp:TextBox>--%>
