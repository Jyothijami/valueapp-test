<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/WarehouseMP1.master" AutoEventWireup="true" CodeFile="StockMovement - Copy.aspx.cs" Inherits="Modules_Warehouse_StockMovement" %>
            ...
            <table style="width: 100%" runat="server" id="internalDCtbl" visible="false">
                ...
                <tr>
                    <td colspan="4">
                        <table class="stacktable">
                            <%--<tr>
                        <td colspan="4" class="profilehead">Moving Details</td>
                    </tr>--%>
                            <tr>
                                <td style="text-align: right">
                            ...
                            <tr>
                                <td style="text-align: right">
                                    <asp:Label ID="Label13" runat="server" Text="Moving From :"></asp:Label>
                                </td>
                                <td style="text-align: left">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">QRCode Reader:</td>
...
<%--                                    <textarea id="TextArea1" cols="20" rows="2"></textarea>
                                   ...
                                   <asp:TextBox ID="txtQR" runat ="server" OnTextChanged ="txtQR_TextChanged" AutoPostBack ="true" Enabled ="false"   ></asp:TextBox>
    ...
    <asp:ValidationSummary ID="ValidationSummary2" runat="server" ValidationGroup="id" ShowMessageBox="true" ShowSummary="false" />
             ...
             <script type="text/javascript">
                 var scanner = new Instascan.Scanner({ textbox: document.getElementById('txtQr'), scanPeriod: 5, mirror: false });
                 scanner.addListener('scan', function (c) {
                     document.getElementById('txtQr').value = c;
