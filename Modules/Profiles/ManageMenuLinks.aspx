...
<body>
    ...
    <div>
        ...
        <asp:HyperLink ID="hprMenuOrder" Target="_blank" runat="server" NavigateUrl="~/dev_pages/Manage_UserLinks_Sequence.aspx">Menu Order||</asp:HyperLink>&nbsp;
                ...
                <asp:HyperLink ID="HyperLink1" Target="_blank" runat="server" NavigateUrl="~/dev_pages/ServiceRequest.aspx">Raise Service Requests||</asp:HyperLink>&nbsp; <br />
                        <asp:HyperLink ID="HyperLink3" Target="_blank" runat="server" NavigateUrl="~/dev_pages/SO_Bal_Qty_Update.aspx">Update Puchase Order Balance Qty||</asp:HyperLink>&nbsp; 
                        <asp:HyperLink ID="HyperLink4" Target="_blank" runat="server" NavigateUrl="~/dev_pages/OUTWARD_DC_Update_Stock.aspx">DC Outward Check||</asp:HyperLink>&nbsp; 
                        <asp:HyperLink ID="HyperLink5" Target="_blank" runat="server" NavigateUrl="~/dev_pages/Emp_CR.aspx">Complaint Raise to CC by Sales Executive||</asp:HyperLink>&nbsp;
                        <asp:HyperLink ID="HyperLink6" Target="_blank" runat="server" NavigateUrl="~/dev_pages/ViewCompRaised.aspx">View Complaint Raised||</asp:HyperLink>&nbsp; 
        <br />
        <h3>Manage Admin Accounts</h3>
        <asp:HyperLink ID="HyperLink7" Target="_blank" runat="server" NavigateUrl="http://bhashsms.com/loginlanding.php">BhashSMS.com</asp:HyperLink>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink8" Target="_blank" runat="server" NavigateUrl="https://sso.godaddy.com/?realm=idp&path=%2Fproducts&app=account">Godaddy.com</asp:HyperLink><br />

        <asp:Label ID="lblSMSUserName" runat="server" Text ="User name : " ForeColor ="Red" ></asp:Label> Valueline  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="lblGodaddyUserName" runat="server" Text ="User name : " ForeColor ="Red" ></asp:Label>valueapp<br />
        <asp:Label ID="lblSMSPwd" runat="server" Text ="Password : " ForeColor ="Red" ></asp:Label>12345               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label1" runat="server" Text ="Password : " ForeColor ="Red" ></asp:Label>valueline2014<br />
