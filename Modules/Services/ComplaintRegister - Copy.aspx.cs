...
public partial class Modules_Services_ComplaintRegister : basePage
{
    ...
    public void SendSMS()
    {
        ...
        try
        {
            ...
            if (ddlstatus.SelectedItem.Text == "Open")
            {
                if (ddlAttendBy.SelectedItem.Text == "--")
                {
                    if (rdblIndentfor.SelectedItem.Text == "Executive")
                    {
                        ...
                        objsms.Send_App_SMS_msg91(msfEmp, emp_MNo);
                        ...
                        objsms.Send_App_SMS_msg91(msgtoExe, ExeNo);
                    }
                    else
                    {
                        string msfEmp = "Dear Customer, Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtCRNo.Text + " has been registered. Our Technician will assist you shortly. VALUELINE";
                ...
                else
                {
                    if (rdblIndentfor.SelectedItem.Text == "Executive")
                    {
                        string msfEmp = "Dear Customer, Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtCRNo.Text + " has been registered. Our Technician " + ddlAttendBy.SelectedItem.Text + " 0" + txtTechMobile.Text + " will assist you shortly. Please share OTP - " + lblStartOTP.Text + " with him. VALUELINE";
                        //string emp_MNo = "9059638293";
                        string emp_MNo = txtMobile.Text;
                        objsms.Send_App_SMS_msg91(msfEmp, emp_MNo);
                        pagenavigationstr = "http://183.82.108.55/CRTech.aspx?CRID=" + lblCRDetID.Text+"";
                        //pagenavigationstr = "http://183.82.108.55/CRTech.aspx?CRID="+lblCRIDHidden.Text +"&CRNo="+txtCRNo.Text+"";
                        ...
                        objsms.Send_App_SMS_msg91(msgtoTech, TechNo);
            ...
            else if (ddlstatus.SelectedItem.Text == "Pending")
            {
                if (rdblIndentfor.SelectedItem.Text == "Executive")
                {
                    string msgtoExe = "Dear " + ddlSalesExecutive.SelectedItem.Text + ", Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtCRNo.Text + " , Customer " + ddlCustomerName.SelectedItem.Text + " is Pending for now. For details contact " + ddlAttendBy.SelectedItem.Text + " 0" + txtTechMobile.Text + ". VALUELINE";
                    string ExeNo = txtExeMobile.Text;
                    objsms.Send_App_SMS_msg91(msgtoExe, ExeNo);
                }
            }
    ...
    public void SendSMSUpdateToCustomer()
    {
        ...
        if (ddlstatus.SelectedItem.Text == "Open")
        {
            if (ddlAttendBy.SelectedItem.Text != "--")
            {
                string msfEmp = "Dear Customer, Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtCRNo.Text + " has been assigned to our Technician " + ddlAttendBy.SelectedItem.Text + " 0" + txtTechMobile.Text + " Please share OTP - " + lblStartOTP.Text + " with him. VALUELINE";
                //string emp_MNo = "9059638293";
                string emp_MNo = txtMobile.Text;
                objsms.Send_App_SMS_msg91(msfEmp, emp_MNo);
            }
    ...
    public void SendSMSUpdateToExecutive()
    {
        try
        {
            ...
            else if (ddlstatus.SelectedItem.Text == "Pending")
            {
                ...
                if (rdblIndentfor.SelectedItem.Text == "Executive")
                {
                    string msgtoExe = "Dear " + ddlSalesExecutive.SelectedItem.Text + ", Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtCRNo.Text + " is pending for now. For details contact " + ddlAttendBy.SelectedItem.Text + " 0" + txtTechMobile.Text + ". Customer " + ddlCustomerName.SelectedItem.Text + ". VALUELINE";
                    string ExeNo = txtExeMobile.Text;
                    objsms.Send_App_SMS_msg91(msgtoExe, ExeNo);
                }
    ...
    public void SendSMSUpdateToTechnician()
    {
        ...
        else if (ddlstatus.SelectedItem.Text == "ManuallyClosed")
        {
            if (ddlAttendBy.SelectedItem.Text != "--")
            {
                string msgtoTech = "Dear " + ddlAttendBy.SelectedItem.Text + ", Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtCRNo.Text + " Customer " + ddlCustomerName.SelectedItem.Text +
                    " manually closed for details contact our CC. VALUELINE";
                string TechNo = txtTechMobile.Text;
                objsms.Send_App_SMS_msg91(msgtoTech, TechNo);
            }
        }
    ...
    protected void btnCompReopen_Click(object sender, EventArgs e)
    {
        if (gvCompHistory.SelectedIndex > -1)
        {
            if (gvCompHistory.SelectedRow.Cells[18].Text == "Pending")
            {
                ...
                {
                    lblCRDate.Text = Convert.ToDateTime(txtCRDate.Text).ToString("dd/MM/yyyy");
                    string msfEmp = "Dear Customer, Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtTechCRNo.Text + " Dated " + lblCRDate.Text + " has been reopened and assigned to Technician " + ddlAttendBy.SelectedItem.Text + " 0" + txtTechMobile.Text + " Please share OTP - " + lblStartOTP.Text + " with him when he visits your location. VALUELINE";
                    //string emp_MNo = "9059638293";
                    string emp_MNo = txtMobile.Text;
                    objsms.Send_App_SMS_msg91(msfEmp, emp_MNo);
                    //myHyperLink.NavigateUrl = string.Format("~/CRTech.aspx?CRid={0}", lblCRIDHidden.Text);
                    pagenavigationstr = "http://183.82.108.55/CRTech.aspx?CRID=" + lblCRDetID.Text + "";
                    //pagenavigationstr = "http://183.82.108.55/CRTech.aspx?CRID=" + lblCRIDHidden.Text + "&CRNo"+txtTechCRNo .Text+"";
                    ...
                    string TechNo = txtTechMobile.Text;
                    objsms.Send_App_SMS_msg91(msgtoTech, TechNo);
                    string msgtoExe = "Dear " + ddlSalesExecutive.SelectedItem.Text + ", Your " + ddlCallType.SelectedItem.Text + " Ticket " + txtTechCRNo.Text + " Dated " + lblCRDate.Text + " has been reopened For " + ddlCustomerName.SelectedItem.Text + "and Assigned to " + ddlAttendBy.SelectedItem.Text + " 0" + txtTechMobile.Text + ". VALUELINE";
                    string ExeNo = txtExeMobile.Text;
                    objsms.Send_App_SMS_msg91(msgtoExe, ExeNo);
                }
                else
