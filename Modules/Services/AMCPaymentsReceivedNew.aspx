<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/ServicesMP1.master" AutoEventWireup="true" CodeFile="AMCPaymentsReceivedNew.aspx.cs" Inherits="Modules_Services_AMCPaymentsReceivedNew" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td colspan="4" style="text-align: center; height: 759px;">
                <table border="0" cellpadding="0" cellspacing="0" id="tblServiceReceived" runat="server" visible="true">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left"></td>
                        <td style="text-align: left;">
                            <asp:TextBox ID="txtCashReceivedOn" runat="server" type="date"></asp:TextBox>&nbsp;
