...
public partial class Modules_Services_AMCPaymentsReceived : basePage
{
    ...
    {
        User_Permissions up = new User_Permissions(Session["vl_userid"].ToString(), "42");
    ...
    {
        Response.Redirect("AMCPaymentsReceivedNew.aspx");
    ...
    
    {
        ...
        {
            Response.Redirect("AMCPaymentsReceivedNew.aspx?amcprNo=" + gvPaymentsReceived.SelectedRow.Cells[0].Text);
            //try
            //{
            //    Services.AMCPaymentsReceived objPaymentsReceived = new Services.AMCPaymentsReceived();
