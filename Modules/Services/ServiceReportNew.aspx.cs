...
using vllib;
public partial class Modules_Services_ServiceReportNew : basePage
{
        ...
        if(!IsPostBack)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (objServiceReport.ServiceReport_Select(srNo) > 0)
                    {
    ...
    private void setControlsVisibility()
    {
        ...
        //btnClose.Enabled = up.Delete;
        //btnCr.Enabled = up.Delete;
    }
    ...
    private void EmployeeMaster_Fill()
    {
        try
        {
           ...
           // HR.EmployeeMaster.EmployeeMaster_Select(ddlVisitedBy);
            HR.EmployeeMaster.EmployeeMaster_SelectCustomerCareTechnical(ddlVisitedBy);
    ...
    private void CRNo_Fill()
    {
        ...
        else if (rbServiceType.SelectedItem.Text == "Complaint")
        {
            try
            {
                Services.ComplaintRegister.ComplaintRegisterForComplaint_Select(ddlCRNo);
        ...
        else if (rbServiceType.SelectedItem.Text == "Technical Guidance")
        {
            try
            {
                Services.ComplaintRegister.ComplaintRegisterForTechnical_Guidance_Select(ddlCRNo);
                //ddlOrderNo.Enabled = ddlCRNo.Enabled = false;
                //rbWarrantySelect.Visible = true;
            }
            catch (Exception ex)
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ServiceReport.aspx");
    }
    #endregion
    ...
    private void ServiceReportSave()
    {
        ...
        try
        {
           ...
           // objServiceReport.CustDetId = ddlContactPerson.SelectedItem.Value;
            ...
            else if (rbServiceType.SelectedValue == "Complaint")
            {
                objServiceReport.SRServiceType = rbServiceType.SelectedItem.Text;
                objServiceReport.SPOId = "0";
                objServiceReport.SOId = "0";
            ...
            else if (rbServiceType.SelectedValue == "Technical Guidance")
            {
                objServiceReport.SRServiceType = rbServiceType.SelectedItem.Text;
                objServiceReport.SPOId = "0";
                objServiceReport.SOId = "0";
    ...
    protected void ddlCustomerName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                lblUnitadd.Text = "Unit Address";
            }
            else
            {
                lblUnitadd.Text = "Customer Address";
                if (objServiceCust.ServiceCustMaster_Select(ddlCustomerName.SelectedItem.Value) > 0)
                {
                    //Bind Customer Details
                    txtContactPerson.Text = objServiceCust.Cust_Contact_Person;
                    txtCustUnitAddress.Text = objServiceCust.Cust_Address;
                    lblCustMobile.Text = objServiceCust.Contact_Mobile;
    ...
    protected void ddlUnitName_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                txtContactPerson.Text = objSMCustomer.Unit_Contact_Person;
                txtCustUnitAddress.Text = objSMCustomer.Cust_Unit_Address;
                lblCustMobile.Text = objSMCustomer.Contact_Mobile;
            }
            Services.Dispose();
        }
        catch (Exception ex)
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        //string emp_MNo = "9885449029";
        string emp_MNo = lblCustMobile.Text;
        string msfEmp = "Your " + txtCallType.Text + " No. " + ddlCRNo.SelectedItem.Text + " Dt: " + txtCRDate.Text + " has been resolved on " + str + ". For any assistance contact 040-23554474/75 -VALUELINE";
        //string msfEmp = "Your " + txtCallType.Text + " No. " + ddlCRNo.SelectedItem.Text + " date " + txtCRDate.Text + " has been resolved as on " + str + ". Any enquiry contact no 040-23554474/75.-VALUELINE";
        //string msfEmp = "Dear Customer we thank you for the oppertunity to serve you. Trust your complaint " + ddlCRNo.SelectedItem.Text + " has been resolved.For any assiatance contact 8008103089.-VALUELINE";
        objsms.Send_App_SMS(msfEmp, emp_MNo);
        Response.Redirect("ServiceReport.aspx");
        //if (srNo!="")
        //{
        //    string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=servicerpt&srid=" + srNo + "";
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        if (srNo!="")
        {
            string pagenavigationstr = "../Reports/ServicesReportViewer.aspx?type=quot&qno=" + srNo + "";
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "rptwindow", "window.open('" + pagenavigationstr + "','rptview','resizable=yes,scrool=yes,width=900,height=600,status=yes,toolbar=no,menubar=no,scrollbars=yes')", true);
        }
        else
        {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (gvServiceItems.Rows.Count > 0)
        {
            foreach (GridViewRow gvrow in gvServiceItems.Rows)
            {
                if (gvServiceItems.SelectedIndex > -1)
                {
                    ...
                    {
                        DataRow dr = QuotationItems.NewRow();
                        dr["ItemType"] = txtModelNo.Text;
                        //dr["ItemCode"] = ddlItemName.SelectedItem.Value;
                        dr["ItemName"] = txtBrandName.Text;
        ...
        if (gvServiceItems.SelectedIndex == -1)
        {
            ...
            drnew["ItemType"] = txtModelNo.Text;
            drnew["ItemName"] = txtBrandName.Text;
    ...
    protected void lbtnPrint_Click(object sender, EventArgs e)
    {
        ...
        if (srNo!="")
        {
            string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=servicerpt&srid=" + srNo + "&srid2=" + gvServiceItems.SelectedRow.Cells[9].Text + "";
            System.Web.UI.ScriptManager.RegisterStartupScript(this, this.GetType(), "rptwindow", "window.open('" + pagenavigationstr + "','rptview','resizable=yes,scrool=yes,width=900,height=600,status=yes,toolbar=no,menubar=no,scrollbars=yes')", true);
        }
        else
        {
    ...
    protected void gvServiceItems_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    protected void btnSendSMS_Click(object sender, EventArgs e)
    {
        HR.SendSMS objsms = new HR.SendSMS();
        ////Send MSG to Employee
        string emp_MNo = "8712349179";
        string emp_MNo2 = lblCustMobile.Text;
        string msfEmp = "Your " + txtCallType.Text + " no" + ddlCRNo.SelectedItem.Text + "date" + txtCRDate.Text + "has been resolve as on" + txtSRDate1.Text + ". Any enquiry contact no 040-23554474/75.-VALUELINE";
        objsms.Send_App_SMS(msfEmp, emp_MNo);
    }
