<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerInformationNew.aspx.cs" Inherits="Modules_Services_CustomerInformationNew" %>
                                ...
                                <tr>
                                    <td colspan="2" style="text-align: center">
                                        <asp:Button ID="btnUnitsAdd" runat="server" BackColor="Transparent" BorderStyle="None"
                                            ...
                                            ValidationGroup="unit" meta:resourcekey="btnUnitsAddResource1" Height="16px" />
