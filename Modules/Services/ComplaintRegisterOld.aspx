<%@ Page Language="C#" MasterPageFile="~/MPs/ServicesMP1.master" AutoEventWireup="true"
    CodeFile="ComplaintRegisterOld.aspx.cs" Inherits="Modules_Services_ComplaintRegister"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <asp:TextBox ID="txtPageNo" Width="100px" runat="server"></asp:TextBox>
                                            ...
                                            <td style="height: 25px; text-align: right;">
                                                ...
                                                <asp:DropDownList ID="ddlSearchBy" runat="server" AutoPostBack="True" CssClass="textbox"
                                                    ...
                                                    <asp:ListItem Value ="Count" >Count of Comp Atteneded</asp:ListItem>
                                                </asp:DropDownList>
                ...
                <tr>
                    <td colspan="4" align="center">
                         <asp:GridView ID="gvCountComp" runat="server" AutoGenerateColumns="False" 
                            AllowSorting="True" DataSourceID="SqlDataSource2" Width="100%" 
                            SelectedRowStyle-BackColor="#c0c0c0" AllowPaging="True" Visible ="false" >
                             <Columns >
                                ...
                                <asp:BoundField DataField="Cust_id" HeaderText="Total Count of Compliants Attended" SortExpression="Contact_Mobile" />
                                <asp:BoundField DataField="custid" HeaderText="Custid" SortExpression="Contact_Mobile" />
                             </Columns>
                         </asp:GridView>
                    </td>
                </tr>
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="lblSearchValueHidden" DefaultValue="0" Name="SearchValue" PropertyName="Text" Type="String" />
                        ...
                        <asp:SqlDataSource ID="sdsComplaintRegister" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_COMPLAINT_REGISTER_SEARCH_SELECT" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="lblSearchItemHidden" DefaultValue="0" Name="SearchItemName" PropertyName="Text" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_COMPLAINT_REGISTER_SEARCH_SELECT_Count" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="lblSearchItemHidden" DefaultValue="0" Name="SearchItemName" PropertyName="Text" Type="String" />
                                <asp:ControlParameter ControlID="lblSearchTypeHidden" DefaultValue="0" Name="SearchType" PropertyName="Text" Type="String" />
                                <asp:ControlParameter ControlID="lblSearchValueHidden" DefaultValue="0" Name="SearchValue" PropertyName="Text" Type="String" />
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" id="tblComplaintRegister" runat="server"
                                        ...
                                        <tr runat="server" id="Tr17">
                                            ...
                                            <td style="text-align: left" id="Td48">
                                                <asp:TextBox ID="txtCRDate" runat="server" type="datepic" EnableTheming="False"></asp:TextBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr runat="server" id="Tr32">
                                            <td colspan="4" style="text-align: center">
                                                <asp:GridView ID="gvQuotationItems" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvQuotationItems_RowDataBound"
                                                    OnRowDeleting="gvQuotationItems_RowDeleting" OnRowEditing="gvQuotationItems_RowEditing" OnRowCancelingEdit ="gvQuotationItems_RowCancelingEdit" OnRowUpdating ="gvQuotationItems_RowUpdating" Width="100%" OnRowCommand="gvQuotationItems_RowCommand">
                                                    <Columns>
                                                    ...
                                                    <asp:BoundField DataField ="AttendBy" HeaderText ="Attend By" />
                                                        <asp:BoundField DataField ="Courtesy_Text" HeaderText="Courtsey Feedback" />
                                                        <asp:BoundField DataField ="Courtesy_By" HeaderText ="Courtest Taken By" />
                                                        <asp:BoundField DataField ="CR_DET_ID" HeaderText ="CRdetId" />
                                                        
                                                        <asp:TemplateField HeaderText="Feedback">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkBtnEdit" runat="server" CommandName="ShowPopup"
                           >Add Courtesy Feedback</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
        ...
        <div id="mask"></div>
         ...
         <table>
             <tr>
                  <td style ="color :red " ><h4>Add Courtesy Feedback:</h4></td>
                 
             </tr>
             <tr>
                 <td>Feedback by Customer :</td>
                 <td><asp:TextBox ID="txtfeedback" runat ="server" TextMode ="MultiLine"  ></asp:TextBox></td>
             </tr>
             <tr>
                 <td>call taken By :</td>
                 <td><asp:DropDownList ID="ddlCourtseyBy" runat ="server"  ></asp:DropDownList></td>
             </tr>
               <tr style ="text-align :right ">
                 <td colspan ="2">
                      <asp:Label ID="lblCRDetId" runat ="server" Visible ="false" ></asp:Label>

                        <asp:Button ID="btnCourtseySave" runat ="server" CssClass="loginbutton" OnClick="btnCourtseySave_Click" EnableTheming="False" Text="Save" />
                    </td>
                          </tr> 
             <tr>
                 <td colspan ="2">
                     <asp:GridView ID="gvCourtseyCallData" runat ="server" Width ="100%"></asp:GridView>
                 </td>
             </tr>
             <tr style ="text-align :center ">
                 <td colspan ="2">
                        <asp:Button ID="btnClose1" runat ="server" CssClass="loginbutton" EnableTheming="False" Text="Close" />
                    </td>
                          </tr> 
         </table>
     </asp:Panel>
                                        ...
                                        <tr runat="server" id="Tr35">
                                            ...
                                            <td style="text-align: left; height: 22px;" id="Td108">
                                                <asp:DropDownList ID="ddlAttendBy" runat="server">
                                                </asp:DropDownList></td>
                                        ...
                                        <tr runat="server" id="Tr36">
                                            ...
                                            <td id="Td114">
                                                <asp:TextBox ID="txtCompletedDate" runat="server" type="datepic" EnableTheming="False"></asp:TextBox>
                                            </td>
                                        </tr>
                                                ...
                                                <table id="tblButtons">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <%--<asp:Button ID="brnSendMail" runat="server" OnClick="brnSendMail_Click" Text="Send Mail" />--%>
