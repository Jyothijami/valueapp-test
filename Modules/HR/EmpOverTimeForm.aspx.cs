...
public partial class HR_EmpOverTimeForm : basePage
{
    ...
    private void EmpOvertimeUpdate()
    {
        try
        {
            ...
            objMaster.OvertimeDate = txtDate.Text;
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        if (gvOvertime.SelectedIndex > -1)
        {
            try
            {
                string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=OverTime&siid=" + gvOvertime.SelectedRow.Cells[0].Text + "";
