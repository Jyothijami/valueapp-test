<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryPrint.aspx.cs" Inherits="Modules_HR_SalaryPrint" %>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left" colspan="2">
                            <asp:TextBox id="txtGrossAmount" runat="server">
                              ...
                              <td align="right">
                            <asp:Label id="Label6" runat="server" Text="Enter Basic Amount :" Width="131px"></asp:Label></td>
                        <td style="width: 100px; text-align: left">
                            <asp:TextBox id="txtBasicAmount" runat="server">
                            </asp:TextBox></td>
                        <td align="right">
                            <asp:Label id="Label7" runat="server" Text="Enter HRA Amount :" Width="131px"></asp:Label></td>
                        <td style="width: 100px; text-align: left">
                            <asp:TextBox id="txtHRAAmount" runat="server">
                            </asp:TextBox></td>
                        <td>
                            <asp:Button ID="Button2" runat="server" OnClick="Button1_Click" Text="Calculate" />
                            &nbsp;
                    ...
                    <tr>
                        <td colspan="4" style="text-align: center">
                            ...
                            <table border="3" cellpadding="2" cellspacing="2">
                                <tr>
                                    <td colspan="2" style="background-color: #33ccff; text-align: left">
