<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/HRMP1.master" AutoEventWireup="true" CodeFile="MD_Approvals.aspx.cs" Inherits="Modules_HR_MD_Approvals" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="pagehead">
                <tr>
                    <td style="text-align: left;">MD Approval Pages :</td>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: center; font-size: medium;">
                        <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl="~/Modules/HR/MDApproval.aspx" Target="_blank">Leave Applications</asp:HyperLink>
                        &nbsp;||&nbsp;
            ...
            <asp:Panel runat="server" ID="OnDutyForm" Visible="false">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONDUTY_SEARCH_SELECT_MD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                ...
                <div id="divGV">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONDUTY_SEARCH_SELECT_MD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
            ...
            <asp:Panel runat="server" ID="OneHourPerm" Visible="false">
                <h4>Pending One Hour Applications</h4>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONHour_SEARCH_SELECT_MD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                ...
                <div id="divOneHr">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONHour_SEARCH_SELECT_MD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
            ...
            <asp:Panel runat="server" ID="OverTime" Visible="false">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_OverTime_SEARCH_SELECT_MD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                    </SelectParameters>
                ...
                <div id="divOvrTime">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_OverTime_SEARCH_SELECT_MD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                        </SelectParameters>
            ...
            <asp:Panel runat="server" ID="ShiftChange" Visible="false">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ShiftChange_SEARCH_SELECT_MD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                    </SelectParameters>
                ...
                <div id="divShiftChange2">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ShiftChange_SEARCH_SELECT_MD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                        </SelectParameters>
            ...
            <asp:Panel runat="server" ID="TicketDetails" Visible="false">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_TICKETDETAILS_SEARCH_SELECT_MD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                    </SelectParameters>
                ...
                <div id="divTicket2">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_TICKETDETAILS_SEARCH_SELECT_MD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                        </SelectParameters>
