<%@ Page Title="||Value App : Leave Master : HR Approval ||" Language="C#" MasterPageFile="~/MPs/HRMP1.master" AutoEventWireup="true" CodeFile="HRApproval.aspx.cs" Inherits="Modules_HR_HRApproval" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">

    <table class="pagehead" style="width: 100%">
        <tr>
            <td colspan="4" style="text-align: left;">HR Pending Leave Applications</td>
        </tr>
    </table>
    <div id="divLeaveApp">
        <table style="width: 100%">
            <tr>
                <td style="text-align: center">
                    <asp:GridView ID="gvHRPendingApps" AutoGenerateColumns="False" runat="server" EmptyDataText="No Records Found" DataSourceID="SqlDataSource1" Width="100%">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SELECT Leave_Id, Emp_Id, 
            ...
            CONVERT (VARCHAR(10), ToDate, 103) AS [To Date], AppliedNoOfLeaves, TypeOfLeave, Reason, AddressInLeavePeriod,FromSession,ToSession,[EMP_Leave_tbl].Comment2 FROM EMP_Leave_tbl WHERE (Status2 = 'Pending' and Status1='Approved')"></asp:SqlDataSource>
    ...
    <asp:Label ID="lblHR_Name" runat="server" Visible="false"></asp:Label>
</asp:Content>
