<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Holiday Calendar.aspx.cs" Inherits="Modules_HR_Holiday_Calendar" %>
...
<title>Vline App Holiday Calender</title>
...
<h1 style="font-size: 30px; font-weight: bold;">Value APP Holiday Calendar</h1>

<div id="tabs">
	<ul>
		<li><a href="#tabs-1">Introduction</a></li>
		<li><a href="#tabs-2">Holiday Calender</a></li>
	</ul>
	<div id="tabs-1">
		
		<p>
		Value App Holiday Calendar was designed to look like Google Calendar.
		</p>
		
		<b>Screenshot 1</b>
		<p>
		<img src="documentationImages/FrontierCalendar10.png" style="border: 0px solid; width:800px;"/>
		</p>		

		<b>Screenshot 2</b>
		<p>
		<img src="documentationImages/FrontierCalendar03.png" style="border: 0px solid; width:800px;"/>
		</p>

		<b>Screenshot 3: IF need we can change the background image on demand.</b>
		<p>
		<img src="documentationImages/FrontierCalendar04.png" style="border: 0px solid; width:800px;"/>
		</p>
	...
	<div id="tabs-2">
		...
		<div class="shadow" style="border: 1px solid #aaaaaa; padding: 5px; text-align: center; ">
			<b style="font-size: medium; color: chocolate;">
