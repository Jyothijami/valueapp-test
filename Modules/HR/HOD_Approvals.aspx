<%@ Page Title="" Language="C#" MasterPageFile="~/MPs/HRMP1.master" AutoEventWireup="true" CodeFile="HOD_Approvals.aspx.cs" Inherits="Modules_HR_HOD_Approvals" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="pagehead">
                <tr>
                    <td style="text-align: left;">HOD Approval Pages :</td>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: center; font-size: medium;">
                        <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl="~/Modules/HR/HODApproval.aspx" Target="_blank">Leave Applications</asp:HyperLink>
                        &nbsp;||&nbsp;
                        ...
                        &nbsp;||&nbsp;
                        <asp:LinkButton ID="lnkReviws" runat ="server" OnClick ="lnkReviws_Click" Font-Underline="True">Employee Reviews</asp:LinkButton>
                    </td>
                </tr>
            </table>
            <br />
            <asp:Panel runat="server" ID="OnDutyForm" Visible="false">
                ...
                <div id="divOnDutyPend">
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                <asp:GridView ID="gvOndutyPend" runat="server" DataSourceID="SqlDataSource1" AllowPaging="True" AutoGenerateColumns="False" Width="100%" SelectedRowStyle-BackColor="#c0c0c0" AllowSorting="True">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Form Id" SortExpression="OnDuty_ID" Visible="true">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="Nature_Of_Work" HeaderText="Nature Of Work" SortExpression="Nature Of Work">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONDUTY_SEARCH_SELECT_HOD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                        <asp:ControlParameter ControlID="lblEmpIdHidden" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
                ...
                <div id="divOnDuty">
                    <asp:GridView ID="gvOnDutyHist" DataSourceID="SqlDataSource2" AllowPaging="True" CssClass="gvStyle" runat="server" Width="100%" AutoGenerateColumns="False">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONDUTY_SEARCH_SELECT_HOD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                            <asp:ControlParameter ControlID="lblDeptId" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
                            <asp:ControlParameter ControlID="lblUserType" DefaultValue="0" Name="userType" PropertyName="Text" Type="Int64" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONEHour_SEARCH_SELECT_HOD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                        <asp:ControlParameter ControlID="lblEmpIdHidden" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
                ...
                <div id="divOneHr">
                    <asp:GridView ID="gvOneHrhist" DataSourceID="SqlDataSource4" AllowPaging="True" CssClass="gvStyle" runat="server" Width="100%" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:BoundField DataField="EMP_FIRST_NAME" HeaderText="Employee Name" SortExpression="EMP_FIRST_NAME" />
                            <asp:BoundField DataField="DEPT_NAME" HeaderText="Department" SortExpression="DEPT_NAME" />
                            <asp:BoundField DataField="OneHour_Date" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Applied Date" HtmlEncode="False" SortExpression="OneHour_Date" />
                            <asp:BoundField DataField="Req_Date" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Required Date" HtmlEncode="False" SortExpression="Req_Date" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ONEHour_SEARCH_SELECT_HOD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                            <asp:ControlParameter ControlID="lblDeptId" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
            ...
            <asp:Panel runat="server" ID="OverTime" Visible="false">
                ...
                <div id="divOverTime">
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                <asp:GridView ID="gvOvertime" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource5" Width="100%" SelectedRowStyle-BackColor="#c0c0c0" AllowSorting="True">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:CheckBox ID="chkhdr" runat="server" AutoPostBack="True" OnClick="selectAll(this)" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_OverTime_SEARCH_SELECT_HOD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                        <asp:ControlParameter ControlID="lblEmpIdHidden" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
                ...
                <div id="divOvrTime">
                    <asp:GridView ID="gvOvertimeHist" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource6" Width="100%" SelectedRowStyle-BackColor="#c0c0c0" AllowSorting="True">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_OverTime_SEARCH_SELECT_HOD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                            <asp:ControlParameter ControlID="lblDeptId" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
            ...
            <asp:Panel runat="server" ID="ShiftChange" Visible="false">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ShiftChange_SEARCH_SELECT_HOD_New" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                        <asp:ControlParameter ControlID="lblEmpIdHidden" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
                ...
                <div id="divShiftChange2">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_ShiftChange_SEARCH_SELECT_HOD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                            <asp:ControlParameter ControlID="lblDeptId" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
            ...
            <asp:Panel runat="server" ID="TicketDetails" Visible="false">
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_TICKETDETAILS_SEARCH_SELECT_HOD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                        <asp:ControlParameter ControlID="lblEmpIdHidden" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
                ...
                <div id="divTicket2">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_TICKETDETAILS_SEARCH_SELECT_HOD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                            <asp:ControlParameter ControlID="lblDeptId" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
            ...
            <asp:Panel runat="server" ID="Panel1" Visible="false">
                <h4>Pending Employee Reviews Applications</h4>
                <%--<div id="divReviews">
                    <table style="width: 100%">
                        <tr>
                            <td style="text-align: center">
                                <asp:GridView ID="gvReview" runat="server" DataSourceID="SqlDataSource9" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="EMP_ID1,DEPT_ID1,DESG_ID1" Width="100%" SelectedRowStyle-BackColor="#c0c0c0" AllowSorting="True">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Id" SortExpression="TicketDetails_Id">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblSurveyId" Text='<%#Eval("Survey_ID")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="EMP_FIRST_NAME" HeaderText="Employee Name" SortExpression="EMP_FIRST_NAME">
                                            <ItemStyle HorizontalAlign="Left" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_TICKETDETAILS_SEARCH_SELECT_HOD" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                                        <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                                        <asp:ControlParameter ControlID="lblEmpIdHidden" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
                        ...
                        <tr>
                            <td style="text-align: center">
                                <asp:Button ID="Button1" runat="server" Text="Approve" OnClick="btnTicketAppr_Click" />

                                &nbsp;<asp:Button ID="Button2" runat="server" Text="Reject" OnClick="btnTicketReject_Click" />
                ...
                <div id="divTicket2">
                    <asp:GridView ID="GridView2" runat="server" DataSourceID="SqlDataSource10" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="EMP_ID1,DEPT_ID1,DESG_ID1" Width="100%" SelectedRowStyle-BackColor="#c0c0c0" AllowSorting="True">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SP_HR_TICKETDETAILS_SEARCH_SELECT_HOD_2" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="0" Name="SearchItemName" Type="String" />
                            <asp:Parameter DefaultValue="0" Name="SearchValue" Type="String" />
                            <asp:ControlParameter ControlID="lblDeptId" DefaultValue="0" Name="DeptId" PropertyName="Text" Type="Int64" />
