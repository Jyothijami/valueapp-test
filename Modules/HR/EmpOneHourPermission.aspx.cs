...
using vllib;
public partial class HR_EmpOneHourPermission : basePage
{
    ...
    private void OnehourUpdate()
    {
        try
        {
            ...
            objMaster.ReqDate = General.toMMDDYYYY(txtReqDate.Text);
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        if (gvOnehourpermission.SelectedIndex > -1)
        {
            ...
            txtReqDate.Text = objmas.ReqDate;
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        if (gvOnehourpermission.SelectedIndex > -1)
        {
            try
            {
                string pagenavigationstr = "../Reports/SMReportViewer.aspx?type=OneHour&siid=" + gvOnehourpermission.SelectedRow.Cells[0].Text + "";
