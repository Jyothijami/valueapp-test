...
public partial class Modules_HR_HOD_Approvals : basePage
{
        ...
        foreach (GridViewRow gvr in gvOndutyPend.Rows)
        {
            if (((CheckBox)gvr.FindControl("Chk")).Checked)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("USP_UpdateHODApproval_OnDuty", con);
        ...
        foreach (GridViewRow gvr in gvOneHrPend.Rows)
        {
            if (((CheckBox)gvr.FindControl("Chk")).Checked)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("USP_UpdateHODApproval_OneHour", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        foreach (GridViewRow gvr in gvOvertime.Rows)
        {
            if (((CheckBox)gvr.FindControl("Chk")).Checked)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("USP_UpdateHODApproval_OverTime", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        foreach (GridViewRow gvr in gvShiftchange.Rows)
        {
            if (((CheckBox)gvr.FindControl("Chk")).Checked)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("USP_UpdateHODApproval_ShiftChange", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        foreach (GridViewRow gvr in gvTicketdetails.Rows)
        {
            if (((CheckBox)gvr.FindControl("Chk")).Checked)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("USP_UpdateHODApproval_TicketDetails", con);
                    cmd.CommandType = CommandType.StoredProcedure;
    ...
    protected void lnkReviws_Click(object sender, EventArgs e)
    {
