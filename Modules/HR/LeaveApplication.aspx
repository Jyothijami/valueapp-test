<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LeaveApplication.aspx.cs" Inherits="Modules_HR_LeaveApplication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderbody" runat="Server">
    ...
    <table class="pagehead" style="width: 100%">
        <tr>
            <td colspan="4" style="text-align: left;">Leave Application <asp:Label ID="ds" Text="(If Leave is availed without MD approval, it will be considered as LOP)" runat ="server" ForeColor ="Red"  ></asp:Label></td>
        </tr>
    </table>
    <div id="divLeaveApp">
        <table>
            ...
            <tr>
                <td></td>
                <td colspan="4">
                    <asp:Label ID="d" runat ="server" Text="Leave has to be applied 2 working days in advance. Please Contact HR" ForeColor ="Red" Font-Bold ="true"  ></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td><asp:DropDownList ID="ddlReportingTo" runat ="server" Enabled ="false"  ></asp:DropDownList>
                    &nbsp; <%--<asp:Label ID="lbltxt" runat ="server" Text ="Note-Your applied leave will go to your reporting Head" ForeColor ="Red"></asp:Label>--%>
                </td>
            </tr>
            <tr style="text-align: left">
            ...
            <tr>
                <td colspan="4">
                    <asp:Label  ID="shownot" runat ="server" Visible ="false" Text="If Leave is availed without MD approval, it will be considered as LOP" Font-Bold="True" ForeColor="Red"></asp:Label>
