          ...
          <%--  <script>
                                        ...
                                        <tr align="right">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlSearchBy" runat="server" CssClass="textbox" meta:resourcekey="ddlSearchByResource1">
                                                    ...
                                                    <asp:ListItem Value="DEPT_NAME" meta:resourcekey="ListItemResource8" Text="Department"></asp:ListItem>
                                                </asp:DropDownList></td>
                                            <td>
                ...
                <tr>
                    <td colspan="4" style="text-align: center; width: 978px;">
                        <asp:GridView ID="gvEmployeeMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="true"
                            DataSourceID="sdsEmployeeMaster" DataKeyNames="EMP_ID" OnRowDataBound="gvEmployeeMaster_RowDataBound" meta:resourcekey="gvEmployeeMasterResource1" OnDataBound="gvEmployeeMaster_DataBound" Width="100%">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CP_FULL_NAME" SortExpression="CP_FULL_NAME" HeaderText="Company" meta:resourceKey="BoundFieldResource9">
                                    <ItemStyle HorizontalAlign="Left"></ItemStyle>

                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="ASSIGNED_EMPID" SortExpression="ASSIGNED_EMPID" HeaderText="A.Emp  Id"></asp:BoundField>
                                <asp:BoundField HtmlEncode="False" SortExpression="EMP_DET_DOT" DataFormatString="{0:dd/MM/yyyy}" DataField="EMP_DET_DOT" HeaderText="DOT"></asp:BoundField>
                            </Columns>
                    ...
                    <td colspan="4" style="text-align: center; width: 978px;">
                        <table id="Table1" align="center">
                            <tr align="center">
                                ...
                                <%--<td>
                                <asp:Button ID="btnEmp_Image" runat="server" OnClientClick="window.open('../HR/Employee_Images.aspx','resume','resizable=yes,scrool=yes,width=900,height=600,status=yes,toolbar=no,menubar=no,scrollbars=yes')"
                                        Text="Employee Image" CausesValidation="False"  />
                            </td>--%>
                            <td>
                        ...
                        <table id="tblEmployeeDetails" runat="server" border="0" cellpadding="0" cellspacing="0"
                            ...
                            Date Of Appointment : 
                                ...
                                <td style="text-align: left;" align="left">
                                    <asp:TextBox ID="txtDateOfAppointment" runat="server" type="date" meta:resourcekey="txtDateOfAppointmentResource1"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; width: 138px;">
                                    <asp:Label ID="Label4" runat="server" Text="Date Of Termination : " Width="138px" meta:resourcekey="Label4Resource1"></asp:Label>
                                    <%--Date Of Termination :--%> 
                                </td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtDateOfTermination" runat="server" type="date" meta:resourcekey="txtDateOfTerminationResource1"></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align: right;">
                                    <asp:Label ID="lblYears" runat="server" Text="Years :" Visible="False"></asp:Label></td>
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtYears" runat="server" Visible="False"></asp:TextBox></td>
                                <td align="right">
                                ...
                                <td style="text-align: left">
                                    <asp:DropDownList ID="ddlBranch" runat="server" Width="154px" meta:resourcekey="ddlBranchResource1">
                                        ...
                                        Font-Size="Smaller" ForeColor="Red" Text="*" Visible="False" meta:resourcekey="Label16Resource1"></asp:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                            ControlToValidate="ddlBranch" ErrorMessage="Please Select Branch" InitialValue="0" Enabled="False" meta:resourcekey="RequiredFieldValidator5Resource1" ValidationGroup="a">*</asp:RequiredFieldValidator></td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
                            ...
                            <tr>
                                <td style="text-align: right">
                                    <asp:Label ID="Label41" runat="server" Text="Gross Salary :"></asp:Label></td>
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtGrosssalary" runat="server">
                                    </asp:TextBox>
                                </td>
                                <td align="right">
            ...
            <td colspan="4">
                    ...
                    <tr>
                        ...
                        <td   style="text-align: left">
                            <asp:TextBox ID="txtAsset2" runat="server" ></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">
                            Asset 3 :
                        ...
                        <td   style="text-align: left">
                            <asp:TextBox ID="txtAsset4" runat="server" ></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">
                            Asset 5 :
                        ...
                        <td   style="text-align: left">
                            <asp:TextBox ID="txtAsset6" runat="server" ></asp:TextBox></td>
                    </tr>
                        ...
                        <td   style="text-align: left">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtDateOfBirth" runat="server" type="date" meta:resourcekey="txtDateOfBirthResource1"></asp:TextBox>
